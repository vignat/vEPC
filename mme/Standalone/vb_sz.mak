...
#
#
#       Sid:      vb_sz.mak@@/main/1 - Mon Jun 28 19:35:29 2010
#
#       Prg:    sn
#
#********************************************************************21*/
...
# for loose coupling
PRDOPTS=-DSZ -DSZ_MME -DSZ_DYNAMIC_PEER -DSZ_USTA -US1AP_REL851 -DLSZV1 \
	-DCM_PASN_ESC_SUPPORT -DCM_PASN_CLASS_IDTYPE -UCM_PASN_DBG    \
        -DLCSZT -DLCLSZ -DLCSCT -DLCSMSZMILSZ -DLCSZMILSZ -DLCUZLISZT \
	-DLWLCSZT -DLCHIUIHIT -DLCSBLIHIT -DLCHIMILHI -DLCSMHIMILHI -DLCLHI \
        -DLCSBUISCT -DLCDMUISCT \
        -DLCLVB -DLCVBMILVB -DLCSMMILVB -DVB_USTA -DCNS_PH1 -DVB_MME -DLCSMVBMILVB \
        -USS_MEM_LEAK_STS -DSB_CHECKSUM -DSB_CHECKSUM_CRC \
        -DS1AP_REL9A6 \
...
PRDACCOPTS=$(PRDOPTS) -DSM -DLCSZLISCT -DLCSZUISZT -DUZ -DDM -DCM_INET2      \
		      ...
		      -DSS_MULTIPLE_PROCS -UDEBUGP -USB_DEBUGP -DSB -DHI -DHI_MULTI_THREADED -DEG -DVB_SB_SCTP
#
# -------------- CSB OPTS for acceptance test build
CSBOPTS=-DSB -DLSB8 -DLSB4 -DHI_REL_1_4 -DCM_INET2 -DLCSCT -DHI -DLCSBUISCT -DSB_CHECKSUM -DSB_CHECKSUM_CRC
#
...
PRDLIBOPTS=$(PRDOPTS) -DDBG4 -DCMFILE_REORG_1 -UPTSZUISZT -DCM_INET2 \
...
GENOSOPTS= -DSS -DCMFILE_REORG_1 -DCMFILE_REORG_2 \
           -DxSS_SINGLE_THREADED -DLONG_MSG \
           -DSLES9_PLUS
...
LIBOSOPTS="-DSS_MT -DSS  -DxSS_SINGLE_THREADED $(GENOSOPTS)"
...
BINLIB=$(LIB_DIR)/libvb_lnx64sz.a
else
# default library for 32 bit linux cc environment
BINLIB=$(LIB_DIR)/libvb_lnx32sz.a
endif
...
# all library sources--------------------------------------------------
PRDLIB_SRCS=  $(SZ_DIR)/sz_ex_ms.c $(SZ_SRCS) $(SZCM_SRCS) $(SM_SRCS) $(SZSM_SRCS) $(SB_SRCS) $(HI_SRCS)

# all library objects--------------------------------------------------
PRDLIB_OBJS= $(SY_DIR)/sz_ex_ms.$(OBJ)  $(SZ_OBJS) $(SZCM_OBJS) $(SM_OBJS) $(SZSM_OBJS) $(SB_OBJS) $(HI_OBJS)
...
$(SY_DIR)/lsb.$(OBJ): $(SB_DIR)/lsb.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS) $(CSBOPTS) $(SB_DIR)/lsb.c -o $(SY_DIR)/lsb.$(OBJ)
...
#********************************************************************30**
#
#        End of file:     vb_sz.mak@@/main/1 - Mon Jun 28 19:35:29 2010
#
#********************************************************************31*/
#
#********************************************************************40**
...
#----------- -------- ---- -----------------------------------------------
#/main/1      ---     sn   1. S1AP Initial Release.
#/main/1+     sz001.101 sn Dynamic peer addition feature added
#/main/2      ---     ng   1. Updated for release of  2.1
