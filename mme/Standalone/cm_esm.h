...
/**********************************************************************
     ...
     Sid:      cm_esm.h@@/main/nodal_main/lp_crfix_branch/1 - Wed Jan 22 19:52:21 2014
...
#define CM_ESM_MAX_PROTO_ID 62
#define CM_ESM_MAX_CONT_ID 0xFF
...
{ \
   ...
   { \
      ...
      {\
         _msgIdx = CM_ESM_EVNT_BEAR_RES_ALLOC_REJ;\
         break;\
      }\
      ...
      {\
         _msgIdx = CM_ESM_EVNT_MODI_BEAR_CTXT_REQ;\
      }\
...
/**********************************************************************
         ...
         End of file:     cm_esm.h@@/main/nodal_main/lp_crfix_branch/1 - Wed Jan 22 19:52:21 2014
