...
/**********************************************************************
     ...
     Sid:      szt_asn.x@@/main/nodal_main/1 - Thu Nov 21 10:40:51 2013

     Prg:      hsingh

**********************************************************************/

/* szt_asn_x_001.main_4: Updated for S1AP Release 3.1 */
#ifdef S1AP_REL851   /* S1AP Release specification 8.5.1 */

#ifndef __SZTASNX__
#define __SZTASNX__ 

/* szt_asn_x_001.main_1 Updated for S1AP release 2.1 */
...
typedef struct s1ap_ExtnBroadcastCompletedAreaLst_ExtIEsCls{
   union {
      TknU8 unused;
   } u;
} Szt_ExtnBroadcastCompletedAreaLst_ExtIEsCls;
typedef struct s1apProtExtnField_BroadcastCompletedAreaLst_ExtIEs
{
   TknPres pres;
   SztProtExtnID id;
   SztCriticality criticality;
   Szt_ExtnBroadcastCompletedAreaLst_ExtIEsCls extensionValue;
} SztProtExtnField_BroadcastCompletedAreaLst_ExtIEs;

typedef struct s1apProtExtnCont_BroadcastCompletedAreaLst_ExtIEs
{
   TknU16 noComp;
   SztProtExtnField_BroadcastCompletedAreaLst_ExtIEs *member;
}SztProtExtnCont_BroadcastCompletedAreaLst_ExtIEs;
...
typedef struct s1apBroadcastCompletedAreaLst
{
   ...
   SztProtExtnCont_BroadcastCompletedAreaLst_ExtIEs iE_Extns;
...
typedef TknU32 SztNumberofBroadcast;
...
/* Element ----- nextHopParameter ------- */
typedef TknU32 SztSecurCntxtnextHopParameter;
...
{
   TknPres pres;
   SztSecurCntxtnextHopParameter nextHopParameter;
   SztSecurKey nextHopChainingCount;
...
typedef struct s1apS_TMSI
{
   TknPres pres;
   SztMME_Code mMEC;
   /* szt_asn_x_001.main_3: added m_TMSI sub IE which was absent in ASN spec 8.5.1 */
   SztM_TMSI m_TMSI;
...
/* szt_asn_x_001.main_3: added GUMMEI IE which was absent in ASN spec 8.5.1 */
...
#endif
/* szt_asn_x_001.main_4: Updated for S1AP Release 3.1 */
#elif (defined S1AP_REL8A0)   /* S1AP release specification 8.10.0 */
...
/* szt_asn_x_001.main_6: Updated for R10 upgrade */

/* szt_asn_x_001.main_5: Updated for release 9.6.0 */
#elif (defined S1AP_REL9A6)   /* S1AP release specification 9.6.0 */
...
#endif
/* szt_asn_x_001.main_6: Updated for R10 upgrade */
#else         /* S1AP release specification 10.3.0 */
...
typedef enum enumSztRprtngTriggerMDT
{
   SztRprtngTriggerMDTperiodicEnum,
   SztRprtngTriggerMDTa2eventtriggeredEnum
} EnumSztRprtngTriggerMDT;
typedef TknU32 SztRprtngTriggerMDT;
...
typedef struct s1ap_ExtnThresholdEventA2_ExtIEsCls{
   union {
      TknU8 unused;
   } u;
} Szt_ExtnThresholdEventA2_ExtIEsCls;
typedef struct s1apProtExtnField_ThresholdEventA2_ExtIEs
{
   TknPres pres;
   SztProtExtnID id;
   SztCriticality criticality;
   Szt_ExtnThresholdEventA2_ExtIEsCls extensionValue;
} SztProtExtnField_ThresholdEventA2_ExtIEs;

typedef struct s1apProtExtnCont_ThresholdEventA2_ExtIEs
{
   TknU16 noComp;
   SztProtExtnField_ThresholdEventA2_ExtIEs *member;
}SztProtExtnCont_ThresholdEventA2_ExtIEs;

typedef struct s1apThresholdEventA2
{
   TknPres pres;
   SztMeasurementThresholdA2 measurementThreshold;
   SztProtExtnCont_ThresholdEventA2_ExtIEs iE_Extns;
} SztThresholdEventA2;
...
typedef struct s1ap_ExtnPeriodicRprtngMDT_ExtIEsCls{
   union {
      TknU8 unused;
   } u;
} Szt_ExtnPeriodicRprtngMDT_ExtIEsCls;
typedef struct s1apProtExtnField_PeriodicRprtngMDT_ExtIEs
{
   TknPres pres;
   SztProtExtnID id;
   SztCriticality criticality;
   Szt_ExtnPeriodicRprtngMDT_ExtIEsCls extensionValue;
} SztProtExtnField_PeriodicRprtngMDT_ExtIEs;

typedef struct s1apProtExtnCont_PeriodicRprtngMDT_ExtIEs
{
   TknU16 noComp;
   SztProtExtnField_PeriodicRprtngMDT_ExtIEs *member;
}SztProtExtnCont_PeriodicRprtngMDT_ExtIEs;

typedef struct s1apPeriodicRprtngMDT
{
   TknPres pres;
   SztReportIntervalMDT reportInterval;
   SztReportAmountMDT reportAmount;
   SztProtExtnCont_PeriodicRprtngMDT_ExtIEs iE_Extns;
} SztPeriodicRprtngMDT;
...
typedef struct s1apImmediateMDT
{
   ...
   SztRprtngTriggerMDT reportingTriggerMDT;
   SztThresholdEventA2 thresholdeventA2;
   SztPeriodicRprtngMDT periodicRprtngMDT;
...
/**********************************************************************
         ...
         End of file:     szt_asn.x@@/main/nodal_main/1 - Thu Nov 21 10:40:51 2013
...
------------ -------- ---- ----------------------------------------------
/main/1      ---     hsingh   1. S1AP Initial Release.
/main/2      ---     hsingh   szt_asn_x_001.main_1 1. Updated for S1AP Release 2.1
/main/3      ---       ajainx   szt_asn_x_001.main_2 1. Updated for S1AP Release 2.2.
/main/4 szt_asn_x_001.main_3 vvashishth 1. Added m_TMSI and GUMMEI elements which were
                                           absent in ASN spec 8.5.1
/main/5 szt_asn_x_001.main_4 pkaX 1.Updated for S1AP Release 3.1.
/main/6      ---      szt_asn_x_001.main_5 pkaX 1.Updated for S1AP Specification release 9.6.0.
/main/7      ---      szt_asn_x_001.main_6    va     1. Updated for S1AP Release 4.1 
*********************************************************************91*/
