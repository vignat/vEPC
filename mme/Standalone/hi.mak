...
#
#       Sid:      hi.mak.00@@/main/1 - Thu Jul 28 14:33:45 2005
#
#       Prg:    asa
#
#********************************************************************21*/
...
HIACCOPTS=$(HIOPTS) -DSM -DHC -DHI_ACC -DHI_ACC_ENB_PRNT \
          #-DHI_ACC_MCAST_ENB
          #-DHI_EXIT_ON_FAILURE \
          #-DHI_TEST_FOREVER \
          #-DHI_ACC_RAW_ENB \
...
WINLIBOPTS="-r -o$(OUTNAME) -F250000 -Zd"
...
$(BINSOLLIB):
	...
	LD=$(SOLLIBLD) COPTS=$(SOLCOPTS) LOPTS=$(SOLLIBOPTS) \
	LIBS="$(SOLIBLIBS) $(SSLLIBS)" INC_PATH=$(ACC_INC_PATH) \
	OSOPTS="$(MTOSOPTS)" OS_SRCS="$(MT_SRCS) $(SS_SRCS)" \
	OBJ=$(UNIX_OBJ_SUFFIX) OS_OBJS="$(MT_OBJS) $(SS_OBJS)" OS_DIR=$(MT_DIR)
...
$(BINGNULIB):
	...
	LD=$(GNULIBLD) COPTS=$(GNUCOPTS) LOPTS=$(GNULIBOPTS) \
	LIBS="$(GNULIBLIBS) $(SSLLIBS)" INC_PATH=$(ACC_INC_PATH) \
	OSOPTS="$(MTOSOPTS)" OS_SRCS="$(MT_SRCS) $(SS_SRCS)" \
	OBJ=$(UNIX_OBJ_SUFFIX) OS_OBJS="$(MT_OBJS) $(SS_OBJS)" OS_DIR=$(MT_DIR)
...
#********************************************************************30**
#
#        End of file:     hi.mak.00@@/main/1 - Thu Jul 28 14:33:45 2005
#
#********************************************************************31*/
#
#********************************************************************40**
