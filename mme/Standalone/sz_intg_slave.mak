...
#
#
#		  Sid:      sz_intg_slave.mak@@/main/3 - Tue May  8 16:04:35 2012
#
#		  Prg:	 sn
#
#********************************************************************21*/
...
# for loose coupling
PRDOPTS=-DSZ -DSZ_MME -DSZ_ENB -DLCSZT -DLCLSZ -DLCSCT -DLCSMSZMILSZ -DLCSZMILSZ -DLCUZLISZT \
		  -DLSZV1 -DCM_PASN_CRIT_HANDL -DCM_PASN_ESC_SUPPORT -DCM_PASN_CLASS_IDTYPE -DCM_PASN_DBG	  \
	-DLWLCSZT -DLCHIUIHIT -DLCSBLIHIT -DLCHIMILHI -DLCSMHIMILHI -DLCLHI -UNO_ERRCLS -DCM_INET2 -DLCSBMILSB -DSZAC_INTG_TEST \
...
PRDACCOPTS=$(PRDOPTS) -USM -DLCSZLISCT -DLCSZUISZT -UUZ -UDM -DCM_INET2		  \
							 -UCMXTA_MASTER -DLWLCSZUISZT -DLWLCUZLISZT -DLCSULISCT \
							 -DxSS_MULTIPLE_PROCS -DDEBUGP -DSB -DHI -DHI_MULTI_THREADED -DSS_DRVR_SUPPORT -DPTSZUISZT -DSZAC_INTG_TEST \
                      -DSZ_ACC_TST_ESC_FUNC
#
...
GENOSOPTS= -DSS -DCMFILE_REORG_1 -DCMFILE_REORG_2 -DCMINETFLATBUF\
			  -DxSS_SINGLE_THREADED -DxLONG_MSG -DCMINET_SINLEN -DxSS_MULTIPLE_PROCS -DCM_INET2 -DSS_DRVR_SUPPORT -DDEBUGNOEXIT -DCMINET_MAX_UDPRAW_SIZE
...
ACC_INC_PATH="-I$(SZ_DIR) -I$(CM_CM_DIR) -I$(CM_LIB_DIR) -I$(CM_HASH_DIR) \
	...
	-I$(CM_SS7_DIR) -I$(SB_DIR) -I$(CM_LLIST_DIR) -I$(CM_MEM_DIR) -I$(CM_LSZ_DIR) -I$(CM_PYTHON_DIR)"
...
SZALL_INC=$(LSZ_INC) $(HIT_INC) $(SZT_INC) $(SZ_INC) $(SB_INC) $(HI_INC)
...
#********************************************************************30**
#
#			End of file:     sz_intg_slave.mak@@/main/3 - Tue May  8 16:04:35 2012
#
#********************************************************************31*/
#
#********************************************************************40**
...
#----------- -------- ---- -----------------------------------------------
#/main/3      ----    va   1. Updated for the Release of 4.1
#********************************************************************91*/
