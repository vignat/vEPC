...
/********************************************************************20**
     ...
     Sid:      cm_lib.c@@/main/nodal_main/1 - Thu Nov 21 09:40:12 2013
...
#ifdef MSPD_MEMCPY /* Using _memcpy (defined by MSPD) for LARM optimization */
   RETVALUE((U8 *) _memcpy((Void *)tgt, (CONSTANT Void *)src, (size_t)len));
#else
...
/********************************************************************30**
         ...
         End of file:     cm_lib.c@@/main/nodal_main/1 - Thu Nov 21 09:40:12 2013
