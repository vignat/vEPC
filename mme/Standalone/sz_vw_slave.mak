...
#
#
#       Sid:      sz_vw_slave.mak@@/main/4 - Tue May  8 16:04:37 2012
#
#       Prg:    vb
#
#********************************************************************21*/
...
# for loose coupling
PRDOPTS=-DSZ -DSZ_MME -DSZ_ENB -DLCSZT -DLCLSZ -DLCSCT -DLCSMSZMILSZ -DLCSZMILSZ -DLCUZLISZT -DCM_PASN_ESC_SUPPORT -DCM_PASN_CLASS_IDTYPE -DCM_PASN_DBG -DLWLCSZT -DLCHIUIHIT -DLCSBLIHIT -DLCHIMILHI -DLCSMHIMILHI -DLCLHI -UNO_ERRCLS -DCM_INET2 -DLCSBMILSB -DLCDMUISCT -DCMIET_LARGE_MAX_UDPRAW_SIZE -DLSZV1 \
-DSZTV1 -DCM_PASN_CRIT_HANDL -US1AP_REL8A0 -US1AP_REL9A6 -DSZTV2
...
PRDACCOPTS=$(PRDOPTS) -USM -DLCSZLISCT -DLCSZUISZT -UUZ -UDM -DCM_INET2 -UCMXTA_MASTER -DLWLCSZUISZT -DLWLCUZLISZT -DLCSULISCT  -DSS_MULTIPLE_PROCS -UDEBUGP -DSB -DHI -DHI_MULTI_THREADED -DSS_DRVR_SUPPORT -DPTSZUISZT -DSZ_ACC_TST_ESC_FUNC
#
...
# Product options for libszry build
...
GENOSOPTS= -DSS -DCMFILE_REORG_1 -DCMFILE_REORG_2 -DCMINETFLATBUF -DSS_VW -DVW_COMPILE -DSS_VW6X\
   -DxSS_SINGLE_THREADED -DxLONG_MSG -DCMINET_SINLEN -DSS_MULTIPLE_PROCS -DCM_INET2 -DSS_DRVR_SUPPORT -DDEBUGNOEXIT -DCMINET_LARGE_MAX_UDPRAW_SIZE
...
# Options for libszry build with MTSS - MOS multithread OS
...
# default libszry for Solaris cc environment
...
# Internal target for the libszry build
MAKELIB=mklib
...
VW_INC=C:/WindRiver/vxworks-6.7/target/h
VW_INC1=C:/WindRiver/vxworks-6.7/target/h/wrn
VW_INC2=C:/WindRiver/vxworks-6.7/target/h/wrn/coreip
VW_INC3=C:/WindRiver/vxworks-6.7/target/h/wrn/coreip/netinet
VW_INC4=C:/WindRiver/vxworks-6.7/sys-include
VW_INC5=C:/WindRiver/vxworks-6.7/target/usr/h
VW_INC6=C:/WindRiver/gnu/4.1.2-vxworks-6.7/lib/gcc/powerpc-wrs-vxworks/4.1.2/include
# libszry include path
LIB_INC_PATH="-I$(SZ_DIR) -I$(SY_DIR) -I$(CM_DIR) -I$(SS_DIR) -I$(VW_DIR) -I$(VW_INC)"
...
ACC_INC_PATH="-I$(SZ_DIR) -I$(CM_CM_DIR) -I$(CM_LIB_DIR) -I$(CM_HASH_DIR) \
   ...
   -I$(CM_SS7_DIR) -I$(SB_DIR) -I$(CM_LLIST_DIR) \
   -I$(VW_INC) -I$(VW_INC1) -I$(VW_INC2) -I$(VW_INC3) -I$(VW_INC4) -I$(VW_INC5) \
   -I$(CM_MEM_DIR) -I$(VW_INC6) -I$(CM_LSZ_DIR)"

# OS - files include path
MSINC_PATH=-I$(CM_DIR) -I$(OS_DIR)

# libszry path - used for integszted products and simulation env.
LIB_PATH=/tmp
...
CPPLOPTS="-o $(OUTNAME) -lpthread -lrt"
CPPLIBS=" -lpthread -lposix4 -lsocket -lnsl -lpython2.4 -lm -ldl"
CPPLINT="lint"
CPPLNTOPTS="-c -F -p -v"
...
GPPLOPTS="-o $(OUTNAME) -lpthread -lrt"
GPPLIBS=""
GPPLINT="lint"
GPPLNTOPTS="-c -F -p -v"
...
#
# For ANSI Compilation
WINENV="-DWIN32 -DWIN2K -DANSI -DSS_NO_DOT_NET -DWIN32_LEAN_AND_MEAN"
...
COSOPTS=$(MODEL) $(ENV) $(COPTS) $(INC_PATH) $(OSOPTS) $(GENOSOPTS)
CSMOSOPTS=-USM $(COSOPTS)
...
# Common Stack Manager File Options for libszry build
...
# DIABLIBS=<libszry files if required>
# DIABLINT=<lint tool>
...
# Product lower Interface - LHI includes
LHI_INC= $(CM_CM_DIR)/lhi.h $(CM_CM_DIR)/lhi.x
...
# common function libszry includes
CM_INC = \
...
SZALL_INC=$(LSZ_INC) $(HIT_INC) $(SZT_INC) $(SZ_INC) $(SB_INC) $(HI_INC) $(VW_INC)
...
# all sctp product includes
SBALL_INC=$(LSB_INC) $(SB_INC) $(HIT_INC) $(SCT_INC)

# all sctp product includes
HIALL_INC=$(LHI_INC) $(HI_INC) $(HIT_INC)
...
#	$(SZACC_DIR)/szac_slave.c  \

#  $(SZACC_DIR)/sz_dbdy1.c  \

# acceptance test object------------------------------------------------
SZ_ACC_OBJS= \
	$(SY_DIR)/szac_prof.$(OBJ)   	  \
	$(SY_DIR)/szac_tst.$(OBJ)   	  \
#	$(SY_DIR)/szac_slave.$(OBJ)   	  \

#  $(SY_DIR)/sz_dbdy1.$(OBJ)

CM_XTA_SRCS= \
	$(SZACC_DIR)/cm_xta_slave.c \
	$(SZACC_DIR)/cm_xta_ipc.c \
...
SM_SRCS= \
	...
	#$(CM_SM_DIR)/smsbbdy1.c \
	#$(CM_SM_DIR)/smhibdy1.c \
...
kw:
	@$(MAKE) -f $(MAKENAME) $(BLDENV) OUTNAME=$(BINKW)  \
    OSOPTS=$(PTOSOPTS) INC_PATH=$(PT_INC_PATH)
...
# Solaris CPP acceptance test build-------------------------------------
#
$(BINCPPACC):
...
#
# Libszry target builds for Solaris CC &  Solaris GNU
#
# Solaris CC libszry build--------------------------------------
#
$(BINSOLLIB):
...
$(SY_DIR)/szac_sb_ex_ms.$(OBJ): $(SZACC_DIR)/szac_sb_ex_ms.c $(SZACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SZACC_DIR)/szac_sb_ex_ms.c -o $(SY_DIR)/szac_sb_ex_ms.$(OBJ)
...
$(SY_DIR)/szac_prof.$(OBJ): $(SZACC_DIR)/szac_prof.c $(SZACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SZACC_DIR)/szac_prof.c -o $(SY_DIR)/szac_prof.$(OBJ)

$(SY_DIR)/szac_slave.$(OBJ): $(SZACC_DIR)/szac_slave.c $(SZACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SZACC_DIR)/szac_slave.c -o $(SY_DIR)/szac_slave.$(OBJ)
...
$(SY_DIR)/sz_dbdy1.$(OBJ): $(SZACC_DIR)/sz_dbdy1.c $(SZACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SZACC_DIR)/sz_dbdy1.c -o $(SY_DIR)/sz_dbdy1.$(OBJ)
...
$(SY_DIR)/smhibdy1.$(OBJ): $(CM_SM_DIR)/smhibdy1.c $(SYS_INC) $(LSZ_INC)
	$(CC) -c $(CPRDOPTS) $(CHIOPTS) $(CSMOPTS) $(CM_SM_DIR)/smhibdy1.c -o $(SY_DIR)/smhibdy1.$(OBJ)
...
$(SY_DIR)/smsbbdy1.$(OBJ): $(CM_SM_DIR)/smsbbdy1.c $(SYS_INC) $(LSZ_INC)
	$(CC) -c $(CPRDOPTS) $(CSBOPTS) $(CSMOPTS) $(CM_SM_DIR)/smsbbdy1.c -o $(SY_DIR)/smsbbdy1.$(OBJ)
...
$(SY_DIR)/lsb.$(OBJ): $(CM_SCT_DIR)/lsb.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CPRDOPTS) $(CSBOPTS) $(CM_SCT_DIR)/lsb.c -o $(SY_DIR)/lsb.$(OBJ)
...
#********************************************************************30**
#
#        End of file:     sz_vw_slave.mak@@/main/4 - Tue May  8 16:04:37 2012
#
#********************************************************************31*/
#
#********************************************************************40**
