...
#Directory path
CODEPATH = ../../src
VBSM_DIR=$(CODEPATH)/mme
# EG files directory
EG_DIR=$(CODEPATH)/egtp
...
# testing
LNXOSOPTS=-DSS_LINUX -DEGACC_PRETTY_PRINT $(MTOSOPTS)
...
LNXENV="-DSUNOS -DSS_LINUX -DANSI -DxUSE_PURE"
...
LEG_INC=$(EG_DIR)/leg.h $(EH_DIR)/leg.x
...
$(SY_DIR)/lhi.$(OBJ): $(HI_DIR)/lhi.c $(SYS_INC) $(EGALL_INC)
...
$(SY_DIR)/eg_dbs2b.$(OBJ): $(EG_DIR)/eg_dbs2b.c $(SYS_INC) $(LEG_INC)
	$(CC) -c $(CPRDOPTS) $(EG_DIR)/eg_dbs2b.c -o $(SY_DIR)/eg_dbs2b.$(OBJ)

$(SY_DIR)/eg_dbs2a.$(OBJ): $(EG_DIR)/eg_dbs2a.c $(SYS_INC) $(LEG_INC)
	$(CC) -c $(CPRDOPTS) $(EG_DIR)/eg_dbs2a.c -o $(SY_DIR)/eg_dbs2a.$(OBJ)
