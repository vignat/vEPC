...
/*eg009.201:Initial Release for s2a interface*/
/***********************************************************************
...
0 );
   ...
   egMakeAppChildIeEntry(&(gmCRTBRERSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_FTEID_IETYPE,EG_IE_CONDITIONAL,10,FALSE,
0 );

   egMakeAppChildIeEntry(&(gmCRTBRERSPCb->ieProperties[ieCnt].groupedIe), grpCnt++, EG_FTEID_IETYPE,EG_IE_CONDITIONAL,11,FALSE,
0 );
...
----------- -------- ---- -----------------------------------------------
/main/1      eg009.201   asaurabh   1. Initial Release for s2a interface
*********************************************************************91*/
