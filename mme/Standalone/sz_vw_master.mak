...
#
#
#       Sid:      sz_vw_master.mak@@/main/4 - Tue May  8 16:04:37 2012
#
#       Prg:    sn
#
#********************************************************************21*/
...
# for loose coupling
PRDOPTS=-DSZ -DSZ_MME -DSZ_ENB -DLCSZT -DLCLSZ -DLCSCT -DLCSMSZMILSZ -DLCSZMILSZ -DLCUZLISZT -DCM_PASN_ESC_SUPPORT -DCM_PASN_CLASS_IDTYPE -DCM_PASN_DBG -DLWLCSZT -DLCHIUIHIT -DLCSBLIHIT -DLCHIMILHI -DLCSMHIMILHI -DLCLHI -UNO_ERRCLS -DLCDMUISCT -DSS_MULTIPLE_PROCS -DLSZV1 \
...
PRDACCOPTS=$(PRDOPTS) -DSM -DLCSZLISCT -DLCSZUISZT -DUZ -DDM -DCM_INET2 -DCMXTA_MASTER -DLWLCSZUISZT -DLWLCUZLISZT -DLCSULISCT  -DSS_MULTIPLE_PROCS -UDEBUGP -DSB -DHI -DHI_MULTI_THREADED -DLCSMSBMILSB -DLCLSB -DLCSBMILSB -DLCSZMILSZ \
-DSZ_ACC_TST_ESC_FUNC

#
# -------------- CSB OPTS for acceptance test build
CSBOPTS=-DSB -DDM -DLSB8 -DHI_REL_1_4 -DCM_INET2 -DLCSCT -DHI -DLCSBUISCT
#
...
GENOSOPTS= -DSS -DCMFILE_REORG_1 -DCMFILE_REORG_2 \
   -DxSS_SINGLE_THREADED -DxLONG_MSG -DSS_MULTIPLE_PROCS -DSS_DRVR_SUPPORT -DCMINET_LARGE_MAX_UDPRAW_SIZE -DNS_ENB_MGMT
...
$(SY_DIR)/szac_db.$(OBJ): $(SZACC_DIR)/szac_db.c $(SZACCALL_INC)
	$(CC) -c $(CPRDOPTS) $(SZACC_DIR)/szac_db.c -o $(SY_DIR)/szac_db.$(OBJ)
...
#********************************************************************30**
#
#        End of file:     sz_vw_master.mak@@/main/4 - Tue May  8 16:04:37 2012
#
#********************************************************************31*/
#
#********************************************************************40**
