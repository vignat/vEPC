...
#
#
#       Sid:      sz_intg_master.mak@@/main/3 - Tue May  8 16:04:34 2012
#
#       Prg:    sn
#
#********************************************************************21*/
...
PRDOPTS=-DSZ -DSZ_MME -DSZ_ENB -DLCSZT -DLCLSZ -DLCSCT -DLCSMSZMILSZ -DLCSZMILSZ -DLCUZLISZT \
	...
	-DLWLCSZT -DLCHIUIHIT -DLCSBLIHIT -DLCHIMILHI -DLCSMHIMILHI -DLCLHI -UNO_ERRCLS -DLCDMUISCT -DSZAC_INTG_TEST \
...
PRDACCOPTS=$(PRDOPTS) -DSM -DLCSZLISCT -DLCSZUISZT -DUZ -DDM -DCM_INET2      \
		      ...
		      -DxSS_MULTIPLE_PROCS -DDEBUGP -DSB -DHI -DHI_MULTI_THREADED -DLCSMSBMILSB -DLCLSB -DLCSBMILSB -DLCSZMILSZ -DSZAC_INTG_TEST \
...
GENOSOPTS= -DSS -DCMFILE_REORG_1 -DCMFILE_REORG_2 \
   -DxSS_SINGLE_THREADED -DxLONG_MSG -DxSS_MULTIPLE_PROCS -DSS_DRVR_SUPPORT -DCMINET_LARGE_MAX_UDPRAW_SIZE
...
#********************************************************************30**
#
#        End of file:     sz_intg_master.mak@@/main/3 - Tue May  8 16:04:34 2012
#
#********************************************************************31*/
#
#********************************************************************40**
