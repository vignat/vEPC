...
#
#       Sid:      hi.mak@@/main/11 - Mon Mar  3 20:09:08 2008
#
#       Prg:    asa
#
#********************************************************************21*/
...
HIOPTS=-DHI $(HITLCFLG) $(LHILCFLG) $(HIDBGFLG) -DCM_INET2 \
       -DHI_MULTI_THREADED -UHI_LKSCTP -DLCHIUISCT -DLCSCT -DPTHIUISCT\
       #-DHI_TLS \
...
#HIOPTS=-DHI $(HITLCFLG) $(LHILCFLG) $(HIDBGFLG) -DCM_INET2 \
       -DHI_MULTI_THREADED -UHI_LKSCTP -DLCHIUISCT -DLCSCT -DPTHIUISCT\
       -DHI_FLAT_BUF -DSS_VW -DSS_VW6X -DVW_COMPILE -DSCT_ENDP_MULTI_IPADDR\
       -UHI_LKSCTP -UCM_LKSCTP -DVW_KSCTP -DCMINETFLATBUF -DSCTP #-DxTRACE2 -DxTRACE3

#-------------------TUCL options for portable build
#HIPTOPTS=$(HIOPTS)

HIPTOPTS=$(HIOPTS) -DSTDIO_INCLD #For SOL & GNU Non ANSI compilation

#-------------------TUCL options for acceptance test build
HIACCOPTS= $(HIOPTS) -DSM -DHC -DHI_ACC -DHI_ACC_ENB_PRNT -UHI_LKSCTP -UCM_LKSCTP -DPTHIUISCT -DLCHCLISCT\
          #-DHI_ACC_MCAST_ENB
          #-DHI_EXIT_ON_FAILURE \
          #-DHI_TEST_FOREVER \
          #-DHI_ACC_RAW_ENB \
...
GENPTOSOPTS=-DCMFILE_REORG_2 -DCMFILE_REORG_1 -UCM_LKSCTP

# Enable for a Multithreaded acceptance test build
GENACCOSOPTS=-DCMFILE_REORG_1 -DCMFILE_REORG_2 -UCM_LKSCTP #-DCONSTDIO -UCM_LKSCTP
...
MTOSOPTS=-DSS_MT -D_REENTRANT -D__EXTENSIONS__ -DSCT_ENDP_MULTI_IPADDR -DDEBUGNOEXIT
...
# testing
LNXOSOPTS=-D_GNU_SOURCE -DSS_LINUX $(MTOSOPTS) -UCM_LKSCTP -DSCT_ENDP_MULTI_IPADDR
...
#SOLENV="-DSUNOS -DANSI -DSUN_KSCTP"

#For Non ANSI Compilation
SOLENV="-DSUNOS -DSUN_KSCTP"

#For Solaris CC (ANSI & Non ANSI) Compilation

SOLCOPTS="-Xa -g"
SOLCC="cc"
SOLLD="cc"
SOLLOPTS="-o $(OUTNAME) -lposix4 -lpthread -lsctp -lsocket -lnsl"
SOLLIBS=""
SOLLINT="lint"
SOLLNTOPTS="-c -F -p -v"

#For Solaris 64 bit compilation

#SOLCOPTS="-Xa -g -mt -xarch=v9"
#SOLCC="cc -DALIGN_64BIT -DBIT_64"
#SOLLD="cc"
#SOLLOPTS="-mt -xarch=v9 -lposix4 -lsctp -lsocket -lnsl -o $(OUTNAME)"
#SOLLIBS=""
#SOLLINT="lint"
#SOLLNTOPTS="-c -F -p -v"
...
#For Solaris C++ Compilation

#SOLCOPTS="-g"
#SOLCC="CC"
#SOLLD="CC"
#SOLLOPTS="-o $(OUTNAME) -lposix4 -lpthread -lsctp -lnsl -lsocket"
#SOLLIBS=""
#SOLLINT="lint"
#SOLLNTOPTS="-c -F -p -v"

#For Solaris Library Compilation
...
PPCENV=-DCPU=SIMNT -DANSI -DPQUICCADS -DVW_KSCTP
PPCCOPTS=-g -mcpu=i486 -msoft-float -fvolatile -fno-builtin -Wall \
	      -Wno-comment -ansi -pedantic -pipe -nostdinc -Wshadow \
	      -Wcast-qual -fsigned-char -DSCTP
...
# For ANSI Compilation
GNUENV="-DSUNOS -DANSI -DSUN_KSCTP"

# For Non ANSI Compilation
#GNUENV="-DSUNOS -DSUN_KSCTP"


# For GNU CC (ANSI & Non ANSI) Compilation
...
GNULD="gcc"
GNULOPTS="-o $(OUTNAME) -lnsl -lsocket -lpthread -lposix4 -lsctp"
GNULIBS=""
GNULINT="lint"
GNULNTOPTS="-c -F -p -v"

# For GNU GCC 64bit Compilation
...
#GNULIBOPTS="-r -o $(OUTNAME)"
#GNULD="gcc"
#GNULOPTS="-m64 -DALIGN_64BIT -DBIT_64 -lposix4 -lsctp -lsocket -lnsl -o $(OUTNAME)"
#GNULIBS=""
#GNULINT="lint"
#GNULNTOPTS="-c -F -p -v"

# For GNU G++ Compilation
...
#LNXCOPTS="-g3 -ansi -Wall -Wno-comment -pipe -Wshadow -Wcast-align -Wcast-qual \
...
LNXLOPTS="-o $(OUTNAME) -lpthread -lnsl -lsctp"
LNXLIBS=""
LNXLINT="lint"
LNXLNTOPTS="-c -F -p -v"
...
#----------------------------------------- Library objects
PRDLIB_OBJS= $(HI_OBJS) $(HI_DIR)/hi_ex_ms.$(OBJ)
#=======================================================================
#
...
#
# Library target builds for Solaris CC, Solaris GNU, Linux
#
# Solaris Library build-------------------------------
#
$(BINSOLLIB):
	@$(MAKE) -f $(MAKENAME) $(MAKELIB) -e ENV=$(SOLENV) CC=$(SOLCC) \
        LD=$(SOLLIBLD) COPTS=$(SOLCOPTS) LOPTS=$(SOLLIBOPTS) LIBS=$(SOLLIBS) INC_PATH=$(LIB_INC_PATH) \
        OSOPTS="$(MTOSOPTS)" OBJ=$(UNIX_OBJ_SUFFIX) OS_DIR=$(MT_DIR) OS_SRCS="$(MT_SRCS)" OS_OBJS="$(MT_OBJS)"

# Solaris GNU Library build-------------------------------
#
$(BINGNULIB):
	@$(MAKE) -f $(MAKENAME) $(MAKELIB) -e ENV=$(GNUENV) CC=$(GNUCC) \
	LD=$(GNULIBLD) COPTS=$(GNUCOPTS) LOPTS=$(GNULIBOPTS) LIBS=$(GNULIBS) INC_PATH=$(LIB_INC_PATH) \
	OSOPTS="$(MTOSOPTS)" OBJ=$(UNIX_OBJ_SUFFIX) OS_DIR=$(MT_DIR) OS_SRCS="$(MT_SRCS)" OS_OBJS="$(MT_OBJS)"
...
$(BINLNXLIB):
	...
	LD=$(LNXLIBLD) COPTS=$(LNXCOPTS) LOPTS=$(LNXLIBOPTS) LIBS=$(LNXLIBS) INC_PATH=$(LIB_INC_PATH) \
	OSOPTS="$(LNXOSOPTS)" OBJ=$(UNIX_OBJ_SUFFIX) OSOPTS=$(LNXLIBOSOPTS) OS_DIR=$(MT_DIR) OS_SRCS="$(MT_SRCS)" OS_OBJS="$(MT_OBJS)"
...
CLIBOPTS=$(CENVOPTS) $(OSOPTS)
PRDLIBOPTS=$(HIOPTS) -DCMFILE_REORG_1 -DCMFILE_REORG_2 -UCM_LKSCTP -DSCT_ENDP_MULTI_IPADDR
CPRDLIBOPTS="$(CLIBOPTS) $(PRDLIBOPTS) $(LIB_INC_PATH)"

LIB_INC_PATH="-I$(HI_DIR) -I$(CM_DIR) -I$(HIACC_DIR) -I$(SSL_DIR) \
              -I$(SM_DIR) -I$(OS_DIR) -I$(SS_DIR) -I$(HIHC_DIR) \
              -I$(HISM_DIR) -I$(SY_DIR)"

$(MAKELIB):
	@$(MAKE) -f $(MAKENAME) $(LIBBIN) CHIOPTS=$(CPRDLIBOPTS) \
        CSMOPTS=$(CSMLIBOPTS)
...
$(SY_DIR)/hi_acc1.$(OBJ): $(HIACC_DIR)/hi_acc1.c
	$(CC) -c $(CHIOPTS) $(HIACC_DIR)/hi_acc1.c

$(SY_DIR)/hi_acc2.$(OBJ): $(HIACC_DIR)/hi_acc2.c
	$(CC) -c $(INC_PATH) $(CHIOPTS) $(HIACC_DIR)/hi_acc2.c
...
$(SY_DIR)/sct.$(OBJ): $(CM_DIR)/sct.c $(SYS_INC) $(CM_INC)
	$(CC) -c $(CHIOPTS) $(CM_DIR)/sct.c
...
#********************************************************************30**
#
#        End of file:     hi.mak@@/main/11 - Mon Mar  3 20:09:08 2008
#
#********************************************************************31*/
#
#********************************************************************40**
...
# /main/10    ---      kp   1. Updated for release 1.5.
# /main/11    ---      hs   1. Updated for release of 2.1
#********************************************************************91*/
