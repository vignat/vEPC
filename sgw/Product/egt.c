...
/********************************************************************20**
     ...
     Sid:      egt.c@@/main/lp_crfix_branch/5 - Wed Feb 18 15:11:38 2015
...
/* ccpu00137922 : New APIs for transparent messages */
#ifdef ANSI
PUBLIC S16 cmPkEgtTransSigReq
(
Pst * pst,
SpId spId,
CmTptAddr * localAddr,
...
#else
PUBLIC S16 cmPkEgtTransSigReq(pst, spId, localAddr, remAddr, lclTeid, transId, t3, egMsg)
Pst * pst;
SpId spId;
CmTptAddr * localAddr;
CmTptAddr * remAddr;
...
#endif
{
   ...
   pst->event = (Event) EVTEGTTRANSSIGREQ;
   RETVALUE(SPstTsk(pst,mBuf));
}
...
#ifdef ANSI
PUBLIC S16 cmUnpkEgtTransSigReq
(
EgtTransSigReq func,
Pst *pst,
Buffer *mBuf,
...
#else
PUBLIC S16 cmUnpkEgtTransSigReq(func, pst, mBuf,memInfo)
EgtTransSigReq func;
Pst *pst;
Buffer *mBuf;
Mem    *memInfo;
#endif
{
   ...
   SPutMsg(mBuf);
   RETVALUE((*func)(pst, spId, &localAddr, &remAddr, lclTeid, transId, t3, egMsg));
}
...
#else
PUBLIC S16 cmPkEgtTransSigRsp(pst, spId, localAddr, remAddr, lclTeid, transId, t3, egMsg)
Pst * pst;
SpId spId;
CmTptAddr * localAddr;
CmTptAddr * remAddr;
...
#endif
{
   ...
   pst->event = (Event) EVTEGTTRANSSIGRSP;
   RETVALUE(SPstTsk(pst,mBuf));
}

#ifdef ANSI
PUBLIC S16 cmUnpkEgtTransSigRsp
(
EgtTransSigRsp func,
Pst *pst,
Buffer *mBuf,
...
#else
PUBLIC S16 cmUnpkEgtTransSigRsp(func, pst, mBuf,memInfo)
EgtTransSigRsp func;
Pst *pst;
Buffer *mBuf;
Mem    *memInfo;
#endif
{
   ...
   SPutMsg(mBuf);
   RETVALUE((*func)(pst, spId, &localAddr, &remAddr, lclTeid, transId, egMsg));
}
...
#endif
{
   ...
   /* ccpu00137627 */
   CMCHKPK(SPkU8, param->bce, mBuf);
   CMCHKPK(SPkU8, param->pce, mBuf);
...
#endif
{
   ...
   /* ccpu00137627 */
   CMCHKUNPK(SUnpkU8, &param->pce, mBuf);
   CMCHKUNPK(SUnpkU8, &param->bce, mBuf);
...
#endif
{
   ...
   CMCHKPK(SPkU8, param->isS6AFPres, mBuf);
   CMCHKPK(SPkU8, param->isS4AFPres, mBuf);
   CMCHKPK(SPkU8, param->isMBMDTPres, mBuf);
   CMCHKPK(SPkU8, param->isISRAUPres, mBuf);
   CMCHKPK(SPkU8, param->isCCRSIPres, mBuf);
   CMCHKPK(SPkU8, param->isSQCIPres, mBuf);
   CMCHKPK(SPkU8, param->isUIMSIPres, mBuf);
...
#endif
{
   ...
   CMCHKUNPK(SUnpkU8, &param->isUIMSIPres, mBuf);
   CMCHKUNPK(SUnpkU8, &param->isSQCIPres, mBuf);
   CMCHKUNPK(SUnpkU8, &param->isCCRSIPres, mBuf);
   CMCHKUNPK(SUnpkU8, &param->isISRAUPres, mBuf);
   CMCHKUNPK(SUnpkU8, &param->isMBMDTPres, mBuf);
   CMCHKUNPK(SUnpkU8, &param->isS4AFPres, mBuf);
   CMCHKUNPK(SUnpkU8, &param->isS6AFPres, mBuf);
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmPkEgLAI
(
EgLAI *param,
Buffer *mBuf
)
#else
PUBLIC S16 cmPkEgLAI(param, mBuf)
EgLAI *param;
Buffer *mBuf;
#endif
{
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmUnpkEgLAI
(
EgLAI *param,
Buffer *mBuf
)
#else
PUBLIC S16 cmUnpkEgLAI(param, mBuf)
EgLAI *param;
Buffer *mBuf;
#endif
{
...
#endif
{
   ...
   CMCHKPK(cmPkEgLAI, &param->lai, mBuf);
   ...
   CMCHKPK(SPkU8, param->isLAIPres, mBuf);
...
#endif
{
   ...
   CMCHKUNPK(SUnpkU8, &param->isLAIPres, mBuf);
   ...
   CMCHKUNPK(cmUnpkEgLAI, &param->lai, mBuf);
   RETVALUE(ROK);
}
...
#endif
{
   ...
   /* ccpu00137940 : Both IPv4 & IPv6 needs to be packed */
   if (param->isIPv6Pres) 
   {
      for (i=16-1; i >= 0; i--) 
      {
         CMCHKPK(SPkU8, param->ipv6Address[i], mBuf);
         }
         }
   if (param->isIPv4Pres) 
   {
      for (i=4-1; i >= 0; i--) 
      {
         CMCHKPK(SPkU8, param->ip4Addr[i], mBuf);
      }
   }
...
#endif
{
   ...
   /* ccpu00137940 : Both IPv4 & IPv6 needs to be unpacked */
   if (param->isIPv4Pres)
   {
      for (i=0; i<4; i++)
      {
         CMCHKUNPK(SUnpkU8, &param->ip4Addr[i], mBuf);
         }
         }
   if (param->isIPv6Pres)
   {
      for (i=0; i<16; i++)
      {
         CMCHKUNPK(SUnpkU8, &param->ipv6Address[i], mBuf);
      }
      }
...
#endif
{
   ...
   for(idx = 0; idx < param->noOfCSIDs ; idx++)
   {   
      CMCHKPK(cmPkEgDatStr16,  &param->csid[idx], mBuf);
   }
...
#endif
{
   ...
   for(idx = param->noOfCSIDs - 1; idx >=0 ;idx--)
   {   
      CMCHKUNPK(cmUnpkEgDatStr16,  &param->csid[idx], mBuf);
   }   
...
#endif
{
   ...
   switch (param->type)
   {
      ...
      case CM_IPV6ADDR_TYPE:
      {
         ...
         for (; cnt > 0; cnt--)
         {
            CMCHKUNPK(SUnpkU8, &param->u.ipv6[cnt-1], mBuf);
         } /* end of loop */
...
#endif /* EG_REL_930 */
#ifdef EG_REL_AC0
   CMCHKPK(SPkU8, param->HighBitRateThan16MbpsLen, mBuf);
   CMCHKPK(SPkU8, param->HighBitRateThan16Mbps, mBuf);
#endif
   RETVALUE(ROK);
...
#ifdef EG_REL_AC0
   CMCHKUNPK(SUnpkU8, &param->HighBitRateThan16Mbps, mBuf);
   CMCHKUNPK(SUnpkU8, &param->HighBitRateThan16MbpsLen, mBuf);
#endif
#if defined(EG_REL_930) || defined(EG_REL_AC0)
   CMCHKUNPK(SUnpkU8, &param->ueUsageSett, mBuf);
   CMCHKUNPK(SUnpkU8, &param->vDomPref, mBuf);
...
#endif
{
   ...
   CMCHKPK(cmPkEgDatStr400,   &param->crm, mBuf);
...
#endif
{
   ...
   CMCHKUNPK(cmUnpkEgDatStr400, &param->crm, mBuf);
...
#endif
{
   ...
   CMCHKPK(cmPkEgDatStr400, &param->fContainer, mBuf);
...
#endif
{
   ...
   CMCHKUNPK(cmUnpkEgDatStr400, &param->fContainer, mBuf);
...
#endif
{
   ...
   CMCHKPK(cmPkEgDatStr16, &param->targetId, mBuf);
...
#endif
{
   ...
   CMCHKUNPK(cmUnpkEgDatStr16, &param->targetId, mBuf);
   RETVALUE(ROK);
...
/* egt_c_001.main_11 - Added for S2B and S2B */   
   for (cnt = EGT_MAX_INTF - 1; cnt >= 0; cnt--)
   {
...
#endif
{
   ...
   CMCHKPK(SPkU8, param->isASIPres, mBuf);
...
#endif
{
   ...
   CMCHKUNPK(SUnpkU8, &param->isASIPres, mBuf);
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmPkEgArp
(
EgARP  *param,
Buffer *mBuf
)
#else
PUBLIC S16 cmPkEgArp(param, mBuf)
EgARP  *param;
Buffer *mBuf;
#endif
{
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmUnpkEgArp
(
EgARP  *param,
Buffer *mBuf
)
#else
PUBLIC S16 cmUnpkEgArp(param, mBuf)
EgARP  *param;
Buffer *mBuf;
#endif
{
   ...
   CMCHKUNPK(SUnpkU8, &param->isPCIPres, mBuf);
   CMCHKUNPK(SUnpkU8, &param->PL, mBuf);
   CMCHKUNPK(SUnpkU8, &param->isPVIPres, mBuf);
...
/* egt_c_001.main_14: ccpu00139510 Egtpc release 10 upgrade */
/***********************************************************
*
*     Func : cmPkEgThrot
*
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmPkEgThrot
(
EgThrottling *param,
Buffer   *mBuf
)
#else
PUBLIC S16 cmPkEgThrot(param, mBuf)
EgThrottling *param;
Buffer   *mBuf;
#endif
{
   ...
   CMCHKPK(SPkU8, param->thrDelayUnit, mBuf);
   CMCHKPK(SPkU8, param->thrDelayValue, mBuf);
   CMCHKPK(SPkU8, param->thrFactor, mBuf);
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmUnpkEgThrot
(
EgThrottling *param,
Buffer    *mBuf
)
#else
PUBLIC S16 cmUnpkEgThrot(param, mBuf)
EgThrottling *param;
Buffer *mBuf;
#endif
{
   ...
   CMCHKUNPK(SUnpkU8, &param->thrFactor, mBuf);
   CMCHKUNPK(SUnpkU8, &param->thrDelayValue, mBuf);
   CMCHKUNPK(SUnpkU8, &param->thrDelayUnit, mBuf);

   RETVALUE(ROK);
} /* end of cmUnpkEgThrot */
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmPkEgEpcTmr
(
EgEPCTmr *param,
Buffer   *mBuf
)
#else
PUBLIC S16 cmPkEgEpcTmr(param, mBuf)
EgEPCTmr *param;
Buffer   *mBuf;
#endif
{
   ...
   CMCHKPK(SPkU8, param->tmrUnit, mBuf);
   CMCHKPK(SPkU8, param->tmrVal, mBuf);
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmUnpkEgEpcTmr
(
EgEPCTmr  *param,
Buffer    *mBuf
)
#else
PUBLIC S16 cmUnpkEgEpcTmr(param, mBuf)
EgEPCTmr *param;
Buffer *mBuf;
#endif
{
   ...
   CMCHKUNPK(SUnpkU8, &param->tmrVal, mBuf);
   CMCHKUNPK(SUnpkU8, &param->tmrUnit, mBuf);

   RETVALUE(ROK);
} /* end of cmUnpkEgEpcTmr */



/***********************************************************
*
*     Func : cmPkEgCngRptFlg
*
*
*     Desc : Pack Change to Report Flag
*
*
*     Ret  : S16
*
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmPkEgCngRptFlg
(
EgCngToRptFlg *param,
Buffer   *mBuf
)
#else
PUBLIC S16 cmPkEgCngRptFlg(param, mBuf)
EgCngToRptFlg *param;
Buffer   *mBuf;
#endif
{
   TRC3(cmPkEgCngRptFlg);

   CMCHKPK(SPkU8, param->isSNCRPres, mBuf);
   CMCHKPK(SPkU8, param->isTZCRPres, mBuf);

   RETVALUE(ROK);
} /* end of cmPkEgCngRptFlg*/


/***********************************************************
*
*     Func : cmUnpkEgCngRptFlg
*
*
*     Desc : Unpack Change to Report Flag
*
*
*     Ret  : S16
*
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmUnpkEgCngRptFlg
(
EgCngToRptFlg *param,
Buffer    *mBuf
)
#else
PUBLIC S16 cmUnpkEgCngRptFlg(param, mBuf)
EgCNGTORPTFLG *param;
Buffer *mBuf;
#endif
{
   TRC3(cmUnpkEgCngRptFlg);

   CMCHKUNPK(SUnpkU8, &param->isTZCRPres, mBuf);
   CMCHKUNPK(SUnpkU8, &param->isSNCRPres, mBuf);

   RETVALUE(ROK);
} /* end of cmUnpkEgCngRptFlg */
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmPkEgMdtConf
(
EgMDTConf *param,
Buffer   *mBuf
)
#else
PUBLIC S16 cmPkEgMdtConf(param, mBuf)
EgMDTConf *param;
Buffer   *mBuf;
#endif
{
   ...
   CMCHKPK(SPkU8, param->jobType, mBuf);
   for(count = 0; count < 4; count++)
   {
      CMCHKPK(SPkU8, param->listOfMsmt[count], mBuf);
   }
   CMCHKPK(SPkU8, param->rptTrigger, mBuf);
   CMCHKPK(SPkU8, param->rptInterval, mBuf);
   CMCHKPK(SPkU8, param->rptAmount, mBuf);
   CMCHKPK(SPkU8, param->evtThrRsrp, mBuf);
   CMCHKPK(SPkU8, param->evtThrRsrq, mBuf);

   CMCHKPK(cmPkEgDatStr, &param->areaScope, mBuf);

   RETVALUE(ROK);
} /* end of cmPkEgMdtConf*/


/***********************************************************
*
*     Func : cmUnpkEgMdtConf
*
*
*     Desc : Unpack Mdt Conf
*
*
*     Ret  : S16
*
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmUnpkEgMdtConf
(
EgMDTConf *param,
Buffer    *mBuf
)
#else
PUBLIC S16 cmUnpkEgMdtConf(param, mBuf)
EgMDTConf *param;
Buffer *mBuf;
#endif
{
   S32 count = 0;
   TRC3(cmUnpkEgMdtConf);

   CMCHKUNPK(cmUnpkEgDatStr, &param->areaScope, mBuf);
   CMCHKUNPK(SUnpkU8, &param->evtThrRsrq, mBuf);
   CMCHKUNPK(SUnpkU8, &param->evtThrRsrp, mBuf);
   CMCHKUNPK(SUnpkU8, &param->rptAmount, mBuf);
   CMCHKUNPK(SUnpkU8, &param->rptInterval, mBuf);
   CMCHKUNPK(SUnpkU8, &param->rptTrigger, mBuf);
   /* to-Do Remove using the number. USe macros */
   for(count = 4-1; count >= 0; count--)
   {
      CMCHKUNPK(SUnpkU8, &param->listOfMsmt[count], mBuf);
   }
   CMCHKUNPK(SUnpkU8, &param->jobType, mBuf);

   RETVALUE(ROK);
} /* end of cmUnpkEgMdtConf */



/***********************************************************
*
*     Func : cmPkEgCodecList
*
*
*     Desc : Pack Codec List
*
*
*     Ret  : S16
*
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmPkEgCodecList
(
EgCodecList *param,
Buffer   *mBuf
)
#else
PUBLIC S16 cmPkEgCodecList(param, mBuf)
EgCodecList *param;
Buffer   *mBuf;
#endif
{
   ...
   TRC3(cmPkEgCodecList);

   CMCHKPK(SPkU8, param->sysId, mBuf);
   for(count = 0; count < 2; count++)
   {
      CMCHKPK(SPkU8, param->bitMap[count], mBuf);
   }
   CMCHKPK(SPkU8, param->bitMapLen, mBuf);

   RETVALUE(ROK);
} /* end of cmPkEgCodecList*/


/***********************************************************
*
*     Func : cmUnpkEgCodecList
*
*
*     Desc : Unpack Mdt Conf
*
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmUnpkEgCodecList
(
EgCodecList *param,
Buffer    *mBuf
)
#else
PUBLIC S16 cmUnpkEgCodecList(param, mBuf)
EgCodecList *param;
Buffer *mBuf;
#endif
{
   S32 count = 0;
   TRC3(cmUnpkEgCodecList);

   CMCHKUNPK(SUnpkU8, &param->bitMapLen, mBuf);
   /* to-Do Remove using the number. USe macros */
   for(count = 2-1; count >= 0; count--)
   {
      CMCHKUNPK(SUnpkU8, &param->bitMap[count], mBuf);
   }
   CMCHKUNPK(SUnpkU8, &param->sysId, mBuf);

   RETVALUE(ROK);
} /* end of cmUnpkEgCodecList */



/***********************************************************
*
*     Func : cmPkEgMmCntxtForSrvcc
*
*
*     Desc : Pack MM Context for SRVCC
*
*
*     Ret  : S16
*
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmPkEgMmCntxtForSrvcc
(
EgMMCntxtForSrvcc *param,
Buffer   *mBuf
)
#else
PUBLIC S16 cmPkEgMmCntxtForSrvcc(param, mBuf)
EgMMCntxtForSrvcc *param;
Buffer   *mBuf;
#endif
{
   ...
   TRC3(cmPkEgMmCntxtForSrvcc);

   for(count = 0; count < param->classMk2Len; count++)
   {
      CMCHKPK(SPkU8, param->classMk2[count], mBuf);
   }
   CMCHKPK(SPkU8, param->classMk2Len, mBuf);

   for(count = 0; count < param->classMk3Len; count++)
   {
      CMCHKPK(SPkU8, param->classMk3[count], mBuf);
   }
   CMCHKPK(SPkU8, param->classMk3Len, mBuf);

   for(count = 0; count < param->numOfcodecList; count++)
   {
      CMCHKPK(cmPkEgCodecList, &param->codec[count], mBuf);
   }
   CMCHKPK(SPkU8, param->numOfcodecList, mBuf);

   RETVALUE(ROK);
} /* end of cmPkEgMmCntxtForSrvcc*/


/***********************************************************
*
*     Func : cmUnpkEgMmCntxtForSrvcc
*
*
*     Desc : Unpack Mdt Conf
*
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmUnpkEgMmCntxtForSrvcc
(
EgMMCntxtForSrvcc *param,
Buffer    *mBuf
)
#else
PUBLIC S16 cmUnpkEgMmCntxtForSrvcc(param, mBuf)
EgCNGTORPTFLG *param;
Buffer *mBuf;
#endif
{
   S32 count = 0;
   TRC3(cmUnpkEgMmCntxtForSrvcc);

   CMCHKUNPK(SUnpkU8, &param->numOfcodecList, mBuf);
   for(count=(param->numOfcodecList - 1); count >= 0; count--)
   {
      CMCHKUNPK(cmUnpkEgCodecList, &param->codec[count], mBuf);
   }

   CMCHKUNPK(SUnpkU8, &param->classMk3Len, mBuf);
   for(count=(param->classMk3Len - 1); count >= 0; count--)
   {
      CMCHKUNPK(SUnpkU8, &param->classMk3[count], mBuf);
   }

   CMCHKUNPK(SUnpkU8, &param->classMk2Len, mBuf);
   for(count=(param->classMk2Len - 1); count >= 0; count--)
   {
      CMCHKUNPK(SUnpkU8, &param->classMk2[count], mBuf);
   }

   RETVALUE(ROK);
} /* end of cmUnpkEgMmCntxtForSrvcc */
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmPkEgStnSr
(
EgSTNSR *param,
Buffer *mBuf
)
#else
PUBLIC S16 cmPkEgStnSr(param, mBuf)
EgSTNSR *param;
Buffer *mBuf;
#endif
{
   ...
   CMCHKPK(SPkU16, param->length, mBuf);
   CMCHKPK(SPkU8, param->NPI, mBuf);
   CMCHKPK(SPkU8, param->ext, mBuf);
   CMCHKPK(SPkU8, param->NatOfAdd, mBuf);
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmUnpkEgStnSr
(
EgSTNSR *param,
Buffer *mBuf
)
#else
PUBLIC S16 cmUnpkEgStnSr(param, mBuf)
EgSTNSR *param;
Buffer *mBuf;
#endif
{
   ...
   CMCHKUNPK(SUnpkU8, &param->NatOfAdd, mBuf);
   CMCHKUNPK(SUnpkU8, &param->ext, mBuf);
   CMCHKUNPK(SUnpkU8, &param->NPI, mBuf);
   CMCHKUNPK(SUnpkU16, &param->length, mBuf);
   for (i=0; i<param->length; i++) {
      CMCHKUNPK(SUnpkU8, &param->val[i], mBuf);
   }
   ...
   switch(param->dataType) {
     ...
     case EG_PVT_EXTN:
      ...
      case EG_BCD:
         ...
         break;
      case EG_STRING_400:
         CMCHKPK(cmPkEgDatStr400, &param->t.valStr400, mBuf);
         break;
#ifdef EG_REL_AC0
      case EG_ARP:
         CMCHKPK(cmPkEgArp, &param->t.arp, mBuf);
         break;
      case EG_EPC_TMR:
         CMCHKPK(cmPkEgEpcTmr, &param->t.epcTmr, mBuf);
         break;
/* egt_c_001.main_14: ccpu00139510 Egtpc release 10 upgrade */
      case EG_THROTTLING:
         CMCHKPK(cmPkEgThrot, &param->t.egThrot, mBuf);
         break;
      case EG_MDT_CONF:
         CMCHKPK(cmPkEgMdtConf, &param->t.mdtConf, mBuf);
         break;
      case EG_CNG_TO_RPT_FLG:
         CMCHKPK(cmPkEgCngRptFlg, &param->t.cngRptFlg, mBuf);
         break;
      case EG_ADD_MM_CNTXT_SRVCC:
         CMCHKPK(cmPkEgMmCntxtForSrvcc, &param->t.mmCntxtForSrvcc, mBuf);
         break;
      case EG_STN_SR:
         CMCHKPK(cmPkEgStnSr, &param->t.stnsr, mBuf);
         break;
#endif /* EG_REL_AC0 */
   ...
   if(param->dataType == EG_BCD)
   param->dataType=EG_STRING_32;
   CMCHKPK(SPkU8, param->ieInst, mBuf);
   CMCHKPK(SPkU8, param->ieType, mBuf);
   RETVALUE(ROK);
}
...
#endif /* EG_REL_930 */
      case EG_STRING_400:
         CMCHKUNPK(cmUnpkEgDatStr400, &param->t.valStr400, mBuf);
         break;
#ifdef EG_REL_AC0
     case EG_ARP:
         CMCHKUNPK(cmUnpkEgArp, &param->t.arp, mBuf);
         break;
      case EG_EPC_TMR:
         CMCHKUNPK(cmUnpkEgEpcTmr, &param->t.epcTmr, mBuf);
         break;
/* egt_c_001.main_14: ccpu00139510 Egtpc release 10 upgrade */
      case EG_THROTTLING:
         CMCHKUNPK(cmUnpkEgThrot, &param->t.egThrot, mBuf);
         break;
      case EG_MDT_CONF:
         CMCHKUNPK(cmUnpkEgMdtConf, &param->t.mdtConf, mBuf);
         break;
      case EG_CNG_TO_RPT_FLG:
         CMCHKUNPK(cmUnpkEgCngRptFlg, &param->t.cngRptFlg, mBuf);
         break;
      case EG_ADD_MM_CNTXT_SRVCC:
         CMCHKUNPK(cmUnpkEgMmCntxtForSrvcc, &param->t.mmCntxtForSrvcc, mBuf);
         break;
      case EG_STN_SR:
         CMCHKUNPK(cmUnpkEgStnSr, &param->t.stnsr, mBuf);
         break;
#endif /* EG_REL_AC0 */
      default:
         RETVALUE(RFAILED);
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmPkEgDatStr400
(
EgDatStr400 *param,
Buffer *mBuf
)
#else
PUBLIC S16 cmPkEgDatStr400(param, mBuf)
EgDatStr400 *param;
Buffer *mBuf;
#endif
{
...
/***********************************************************
*
*     Func : cmUnpkEgDatStr400
*
*
*     Desc : String -- max 400 byte length
*
*
*     Ret  : S16
*
...
**********************************************************/
#ifdef ANSI
PUBLIC S16 cmUnpkEgDatStr400
(
EgDatStr400 *param,
Buffer *mBuf
)
#else
PUBLIC S16 cmUnpkEgDatStr400(param, mBuf)
EgDatStr400 *param;
Buffer *mBuf;
#endif
{
   U32 i;
   TRC3(cmUnpkEgDatStr400);
...
/********************************************************************30**
         ...
         End of file:     egt.c@@/main/lp_crfix_branch/5 - Wed Feb 18 15:11:38 2015
...
/main/15     ---         egt_c_001.main_14   rss      1. Egtpc Release 10 upgrade
*********************************************************************91*/
