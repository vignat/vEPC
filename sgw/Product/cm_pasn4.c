...
/********************************************************************20**
     ...
     Sid:      cm_pasn4.c@@/main/nodal_main/uchakala_feat_lpdev_sgsn_branch/1 - Fri Jul  4 12:56:37 2014
...
#endif
{
  ...
  U8  val;            /* to store bit field values */ 
  U8  secVal;         /* Another octet to store bit field */
...
#endif
{
  U8      byte;        /* To store bit field value */
...
#endif
{
  ...
  U8    secVal;        /* second unfragmented length */
  U8    noBits;        /* Number of bits */
...
/********************************************************************30**
         ...
         End of file:     cm_pasn4.c@@/main/nodal_main/uchakala_feat_lpdev_sgsn_branch/1 - Fri Jul  4 12:56:37 2014
