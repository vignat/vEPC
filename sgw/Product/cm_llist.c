...
/********************************************************************20**
     ...
     Sid:      cm_llist.c@@/main/nodal_main/1 - Thu Nov 21 09:40:12 2013
...
#ifdef MSPD
   if ((lCp == (CmLListCp *)NULLP) || (node == (CmLList *)NULLP))
      RETVOID;
#endif   
   lCp->count++;
...
/********************************************************************30**
         ...
         End of file:     cm_llist.c@@/main/nodal_main/1 - Thu Nov 21 09:40:12 2013
