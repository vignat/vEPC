...
/********************************************************************20**
     ...
     Sid:      leg.h@@/main/12 - Mon Sep 22 17:23:41 2014
...
/* leg_h_001.main_11 - ccpu00139510 Egtpc release 10 upgrade */
#if defined(EG_REL_AC0) || defined(EG_S2A_SUPP)
#define LEG_MAX_IES_ALL_MSGS       96      /* Max number of Information Elements
                                              for all msg*/
#else
#define LEG_MAX_IES_ALL_MSGS       81      /* Max number of Information Elements 
                                              for all msg*/
#endif
#define LEG_MAX_IES_PER_MSG        60      /* Max number of IE's per Message */
...
/********************************************************************30**
         ...
         End of file:     leg.h@@/main/12 - Mon Sep 22 17:23:41 2014
...
/main/12     ---      leg_h_001.main_11   rss      1. Egtpc Release 10 upgrade
*********************************************************************91*/
