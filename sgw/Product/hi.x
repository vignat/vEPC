...
/********************************************************************20**
     ...
     Sid:      hi.x@@/main/6 - Mon Mar  3 20:09:47 2008
...
/*hi034.201:New structure added for multiple posts SCT interface*/
#ifdef HI_LKSCTP
typedef struct hiUiSctPsts
{
   Pst          uiSctAssocIndPst;
   Pst          uiSctAssocCfmPst;
   Pst          uiSctTermIndPst;
   Pst          uiSctTermCfmPst;
   Pst          uiSctSetPriCfmPst;
   Pst          uiSctHBeatCfmPst;
   Pst          uiSctDatIndPst;
   Pst          uiSctStaIndPst;
   Pst          uiSctFlcIndPst;
...
typedef struct hiSap
{
   ...
   /*hi034.201: new structure declared*/
#ifdef HI_LKSCTP
   HiUiSctPsts   uiSctPsts;    /* Post structure for Sct primitives */
#endif
...
/main/6+   hi034.201  mladdha 1. Added support for multiple post structures in
                                 SCT interface by defining a new structure hiUiSctPsts.
*********************************************************************91*/
