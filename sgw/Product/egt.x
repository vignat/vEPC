...
/********************************************************************20**
     ...
     Sid:      egt.x@@/main/lp_crfix_branch/4 - Wed Feb 18 15:11:39 2015
...
#ifdef EG_REL_AC0
   EGT_GTPC_MSG_PGW_RST_NOTFN = 179,
   EGT_GTPC_MSG_PGW_RST_NOTFN_ACK,
   EGT_GTPC_MSG_MOD_ACC_BRE_REQ = 211,
   EGT_GTPC_MSG_MOD_ACC_BRE_RSP,
#endif
...
EGT_INT_SM_MBMSGW_GTP_C=24,
   EGT_INT_SN_MBMSGW_GTP_C,
EGT_INT_SM_MME_GTP_C,
EGT_INT_SN_SGSN_GTP_C,
#endif /* EG_REL_930 */
/* egt_x_001.main_8 -Added for S2B */
#ifdef EG_REL_AC0
...
typedef enum _egtErrType
{
   ...
   /* fix for  ccpu00136924 */
   EGT_ERR_MSG_INCORR_IE,            /* 50 */
   /* ccpu00137045 */
   EGT_ERR_MSG_INV_PDN_TYPE,         /* 51 */
   EGT_ERR_MSG_INV_IE_INST,          /* 52 */
   EGT_ERR_MSG_MLFRMD_PKT,           /* 53 */
   EGT_ERR_INV_MSG_FMT,               /* 54 invalid message format */
   EGT_ERR_MAX_ERR                    /* 55: Maximum error allowed     */
...
/*********************************
 * String -- max 400 byte length *
 *********************************/
/**@struct _egDatStr400 
   @brief String -- max 400 byte length */
typedef struct _egDatStr400
{
   U16 length;                             /**< Holds length of string*/
   U8 val[400];                           /**< value of string */         
   U16 spare1;                             /**<  Spare bytes to align 4 byte boundary */
#ifdef ALIGN_64BIT
   U32  spare2;                   /**<  for 64 bit alignment */
#endif         
...
typedef struct _egCause
{
   ...
   /* ccpu00137627 : PCE/BCE bits updated*/
   Bool    pce;                   /**<  pce */
   Bool    bce;                   /**<  bce */
...
/**@struct _egSTNSR
   @brief STN-SR */
typedef struct _egSTNSR
{
   U8 ext;                            /**< extension */
   U8  NatOfAdd;                            /**< nature of address */
   U8  NPI;                            /**< numbering plan indicator */
   U16 length;                             /**< Holds length of string*/
   U8 val[16];                            /**< value of STN-SR */
   U16 spare1;                             /**<  Spare bytes to align 4 byte boundary */
#ifdef ALIGN_64BIT
   U32  spare2;                   /**<  for 64 bit alignment */
#endif
...
typedef struct _egIndication
{
  ...
  /* added additional flags as per Release 10 */
   Bool isUIMSIPres;               /**< UIMSI Pres */
   Bool isSQCIPres;               /**< SQCI Pres */

   Bool isCCRSIPres;               /**< CCRS1 Pres */
   Bool isISRAUPres;               /**< ISRAU Pres */
   Bool isMBMDTPres;               /**< MBMDT Pres */
   Bool isS4AFPres;               /**< S4AF Pres */
   Bool isS6AFPres;               /**< SA6F Pres */
} EgIndication;


/* egt_x_001.main_11: ccpu00139510 Egtpc release 10 upgrade */
/**************
 * ARP*
 **************/
/**@struct _egARP 
   @brief ARP */
typedef struct _egARP
{
   Bool isPVIPres;              /**< PVI  Pres */
/* To-Do Mavnir Make it small case */
   U8 PL;              /**< PL*/
   Bool isPCIPres;              /**< PCI Pres */
} EgARP;
 ...
 * CNG_TO_RPT_FLG*
 **************/
/**@struct _egCNGTORPTFLG 
   @brief CNG_TO_RPT_FLG*/
typedef struct _egCNGTORPTFLG
{
   Bool isSNCRPres;              /**< SNCR  Pres */
   Bool isTZCRPres;              /**< TZCR Pres */
} EgCngToRptFlg;
...
/**********************************
 * Additional MM Context or SRVCC *
 **********************************/
/**@struct _egMMCntxtForSrvcc 
   @brief egMMCntxtForSrvcc*/
typedef struct _egMMCntxtForSrvcc
{
   U8 classMk2Len;
   U8 classMk2[3];
   U8 classMk3Len;
...
/****************************
 * Location Area Identifier * // added as per release 10 
 ****************************/
/**@struct _egLAI 
   @brief location Area Identifier */
typedef struct _egLAI
{
   EgSNetwork sNwk;                       /**<  Serving Network */
   U16        lac;                        /**<  Location Area Code*/
} EgLAI;
...
typedef struct _egUli
{
   ...
   Bool  isLAIPres;                      /**< LAI> as per release 10*/
   ...
   EgLAI lai;                           /**<  location area code> as per release 10 */
} EgUli;
...
typedef struct _egFTeid
{
   ...
   /* ccpu00137940 : IPv4 and IPv6 can be sent simultaneously */
...
typedef struct _egBearFlags
{
   ...
   Bool isASIPres;                           /**< Activity status indicator(ASI) Present */
} EgBearFlags;
...
typedef struct _egCrm
{
   ...
   EgDatStr400 crm;                         /**< Complete Request Message */
} EgCrm;
...
typedef struct _egFContainer
{
   ...
   EgDatStr400  fContainer;                  /**< F-Container field */
} EgFContainer;
/*************************
...
typedef struct _egTargetId
{
   ...
   EgDatStr16  targetId;                            /**< Target ID - Max length 28-bits (25413.830) */
} EgTargetId;
...
typedef struct _egCsid
{
   ...
   /* ccpu00137353 */
   EgDatStr16 csid[20];                                /**< PDN Connection Set Identifier (CSID) - Max 16 Octets */
...
#endif
#ifdef EG_REL_AC0
   U8                 HighBitRateThan16MbpsLen;           /**< Higher bit rate than 16 Mbps flag length */
   U8                 HighBitRateThan16Mbps;           /**< Higher bit rate than 16 Mbps flag*/
#endif
} EgUMTSKeyUCQt;
...
/**@struct _egEPC_TMR
   @brief EPC TIMER*/
typedef struct _egThrottling
{
   U8            thrDelayUnit;                 /**< Throttling Delay Unit */
   U8            thrDelayValue;                /**< Throttling Delay Value*/
   U8            thrFactor;                    /**< Throttling Factor */
} EgThrottling;
...
/**@struct _egEPC_TMR
   @brief EPC TIMER*/
typedef struct _egEPCTMR
{
   U8            tmrUnit;                 /**< Timer unit */
   U8            tmrVal;                 /**< Timer value */
} EgEPCTmr;
...
typedef struct _egIe
{
  ...
  /* ccpu00137045 : is decoded IE Valid */
  U8         ieInValidCause;
  union
  {
     ...
     EgDatStr400   valStr400;             /**< String of maximum length 400 bytes*/
     ...
     EgARP  arp;            /**< ARP */
     EgEPCTmr  epcTmr;            /**< ARP */
     EgMDTConf  mdtConf;            /**< MDT configuration */
     EgCngToRptFlg cngRptFlg;/**< CNGTORPTFLG */
     EgMMCntxtForSrvcc mmCntxtForSrvcc;
     EgThrottling   egThrot;
#endif
...
/* ccpu00137922 */
typedef S16 (*EgtTransSigReq)   ARGS((
               Pst         *pst,       /* post structure */
               SpId        spId,       /* eGTP service provider SAP ID */ 
               CmTptAddr   *localAddr, /* Local node address */
               CmTptAddr   *remAddr,   /* Remote node address */
...
/* ccpu00137922 */
typedef S16 (*EgtTransSigRsp)   ARGS((
               Pst         *pst,       /* post structure */
               SpId        spId,       /* eGTP service provider SAP ID */ 
               CmTptAddr   *localAddr, /* Local node address */
               CmTptAddr   *remAddr,   /* Remote node address */
...
EXTERN S16 EgUiEgtTransSigReq ARGS (( Pst *pst, SpId spId, CmTptAddr *localAddr, 
                                 CmTptAddr *remAddr, TknU32 lclTeid, TknU32 transId, 
                                 TmrCfg t3, EgMsg *egMsg));
...
EXTERN S16 EgUiEgtTransSigRsp ARGS (( Pst *pst, SpId spId, CmTptAddr *localAddr, CmTptAddr *remAddr,
                                      TknU32 lclTeid, TknU32 transId, EgMsg *egMsg));
...
EXTERN S16 EuLiEgtTransSigReq ARGS (( Pst *pst, SpId spId, CmTptAddr *localAddr, 
                                 CmTptAddr *remAddr, TknU32 lclTeid, TknU32 transId, 
                                 TmrCfg t3, EgMsg *egMsg));
...
EXTERN S16 EuLiEgtTransSigRsp ARGS (( Pst *pst, SpId spId, CmTptAddr *localAddr, 
                                 CmTptAddr *remAddr, TknU32 lclTeid, TknU32 transId, 
                                 EgMsg *egMsg));
...
EXTERN S16 cmUnpkEgtTransSigReq
ARGS((
EgtTransSigReq func,
Pst *pst,
Buffer *mBuf,
...
EXTERN S16 cmUnpkEgtTransSigRsp
ARGS((
EgtTransSigRsp func,
Pst *pst,
Buffer *mBuf,
...
EXTERN S16 cmPkEgDatStr400 ARGS
((
EgDatStr400 *param,
Buffer *mBuf
));

EXTERN S16 cmUnpkEgDatStr400 ARGS
((
EgDatStr400 *param,
Buffer *mBuf
));
...
#ifdef EG_REL_AC0
EXTERN S16 cmPkEgArp ARGS
((
EgARP  *param,
Buffer *mBuf
));

EXTERN S16 cmUnpkEgArp ARGS
((
EgARP  *param,
Buffer *mBuf
));

EXTERN S16 cmPkEgEpcTmr ARGS
((
EgEPCTmr *param,
Buffer   *mBuf
));

EXTERN S16 cmUnpkEgEpcTmr ARGS
((
EgEPCTmr *param,
Buffer   *mBuf
));

EXTERN S16 cmPkEgThrot ARGS
((
EgThrottling *param,
Buffer   *mBuf
));

EXTERN S16 cmUnpkEgThrot ARGS
((
EgThrottling *param,
Buffer   *mBuf
));

EXTERN S16 cmPkEgCngRptFlg ARGS
((
EgCngToRptFlg *param,
Buffer   *mBuf
));

EXTERN S16 cmUnpkEgCngRptFlg ARGS
((
EgCngToRptFlg *param,
Buffer   *mBuf
));

EXTERN S16 cmPkEgMdtConf ARGS
((
EgMDTConf *param,
Buffer   *mBuf
));

EXTERN S16 cmUnpkEgMdtConf ARGS
((
EgMDTConf *param,
Buffer   *mBuf
));

EXTERN S16 cmPkEgCodecList ARGS
((
EgCodecList *param,
Buffer   *mBuf
));

EXTERN S16 cmUnpkEgCodecList ARGS
((
EgCodecList *param,
Buffer   *mBuf
));

EXTERN S16 cmPkEgMmCntxtForSrvcc ARGS
((
EgMMCntxtForSrvcc *param,
Buffer   *mBuf
));

EXTERN S16 cmUnpkEgMmCntxtForSrvcc ARGS
((
EgMMCntxtForSrvcc *param,
Buffer   *mBuf
));

EXTERN S16 cmPkEgStnSr ARGS
((
EgSTNSR *param,
Buffer *mBuf
));

EXTERN S16 cmUnpkEgStnSr ARGS
((
EgSTNSR *param,
Buffer *mBuf
));
...
/********************************************************************30**
         ...
         End of file:     egt.x@@/main/lp_crfix_branch/4 - Wed Feb 18 15:11:39 2015
...
/main/12     ---      egt_x_001.main_11   rss      1. Egtpc Release 10 upgrade
*********************************************************************91*/
