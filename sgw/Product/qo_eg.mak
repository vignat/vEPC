...
#
#       Sid:      qo_eg.mak@@/main/1 - Thu Jul  8 21:22:16 2010
#
#       Prg:    kc
#
#********************************************************************21*/
...
#EGSM_DIR=$(CODEPATH)/sgw
EGSM_DIR=$(CODEPATH)

# HI stack manager files directory
#HISM_DIR=$(CODEPATH)/sgw
HISM_DIR=$(CODEPATH)
...
EGOPTS = -DEG \
         ...
         -DxEGAC_LOOP_TEST \
         -UIPV6_SUPPORTED \
         -USS_DRVR_SUPPORT -DEGTP_U -DEGTP_C -DLCLEG -DLCEGT -DEG_REL_930 -DEG_PHASE2 \
	 -DLCSMEGMILEG -DLCEGMILEG -DLCEULIEGT  -DLCEGT -DLCEULIEGT -DLWLCEULIEGT\
	 -DLCEGUIEGT -DLWLCEGUIEGT -USS_MEM_LEAK_STS
...
EGLIBOPTS =$(EGOPTS) -DCM_INET2 -DDONT_USE_SYS_LIB -DSS_MT_TMR -DEG_PHASE2 $(LEGLCFLG)  -DEU -DLCEGLIHIT -DLCEGUIEGT

# Product options for Acceptance Test Build - DUMMY TUCL ONLY
EGACCOPTS=$(EGOPTS) -DEG_ACC -DDEBUGP -DEU -DCMXTA_MASTER -DCMXTA_RET_ERR_NONE -DSM $(DHIOPTS) $(EGTLCFLG) $(EGTLWLCFLG) $(LEGLCFLG) -DSS_MULTIPLE_PROCS -DDHI
...
GENLIBOSOPTS=-DLONG_MSG -DCMFILE_REORG_2 -DCMFILE_REORG_1 -DCM_INET2
...
#BINLIB="libqo_lnx64eg.a"
#BINLIB="libqo_sol32eg.a"
#BINLIB="libqo_sol64eg.a"
...
$(SY_DIR)/smegs5.$(OBJ): $(EGM_DIR)/smegs5.c $(SYS_INC) $(LEG_INC)
...
#********************************************************************30**
#
#        End of file:     qo_eg.mak@@/main/1 - Thu Jul  8 21:22:16 2010
#
#********************************************************************31*/
#
#********************************************************************40**
...
#/main/1      qo001.101 rp               1. Changes for patch qo001.101
#********************************************************************91*/
