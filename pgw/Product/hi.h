...
/********************************************************************20**
     ...
     Sid:      hi.h@@/main/6 - Mon Mar  3 20:09:45 2008
...
/*hi034.201: Duplicate Sap Post Structure for SCT interface*/
#ifdef HI_LKSCTP

#define HI_DUPLICATE_SAP_SCTPST(_sap, _pst)                     \
{                                                               \
   if (_sap->type == HI_SCT_SAP)                                \
   {                                                            \
      cmMemcpy((U8 *)&_sap->uiSctPsts.uiSctAssocIndPst,         \
            (U8 *)&_sap->uiPst,                                 \
            sizeof(Pst));                                       \
      cmMemcpy((U8 *)&_sap->uiSctPsts.uiSctAssocCfmPst,         \
            (U8 *)&_sap->uiPst,                                 \
            sizeof(Pst));                                       \
      cmMemcpy((U8 *)&_sap->uiSctPsts.uiSctTermIndPst,          \
            (U8 *)&_sap->uiPst,                                 \
            sizeof(Pst));                                       \
      cmMemcpy((U8 *)&_sap->uiSctPsts.uiSctTermCfmPst,          \
            (U8 *)&_sap->uiPst,                                 \
            sizeof(Pst));                                       \
      cmMemcpy((U8 *)&_sap->uiSctPsts.uiSctSetPriCfmPst,        \
            (U8 *)&_sap->uiPst,                                 \
            sizeof(Pst));                                       \
      cmMemcpy((U8 *)&_sap->uiSctPsts.uiSctHBeatCfmPst,         \
            (U8 *)&_sap->uiPst,                                 \
            sizeof(Pst));                                       \
      cmMemcpy((U8 *)&_sap->uiSctPsts.uiSctDatIndPst,           \
            (U8 *)&_sap->uiPst,                                 \
            sizeof(Pst));                                       \
      cmMemcpy((U8 *)&_sap->uiSctPsts.uiSctStaIndPst,           \
            (U8 *)&_sap->uiPst,                                 \
            sizeof(Pst));                                       \
      cmMemcpy((U8 *)&_sap->uiSctPsts.uiSctFlcIndPst,           \
            (U8 *)&_sap->uiPst,                                 \
            sizeof(Pst));                                       \
   }                                                            \
}                                                               \
...
{                                                               \
   ...
   {                                                            \
      HI_INC_ERRSTS(hiCb.errSts.numFlcInd);                     \
   /*hi034.201: changed the post structure being passed*/  \
      HiUiSctFlcInd(&_conCb->sap->uiSctPsts.uiSctFlcIndPst,     \
                    _conCb->sap->suId, _conCb->suConId,         \
                    _reason);                                   \
   }                                                            \
   hiSendAlarm(LCM_CATEGORY_RESOURCE, (U16)_event,              \
...
/********************************************************************30**
         ...
         End of file:     hi.h@@/main/6 - Mon Mar  3 20:09:45 2008
...
/main/6+   hi034.201  mladdha 1. Added support for multiple post structures in
                                 SCT interface by defining  Duplicate Sap 
                                 Post Structure.
*********************************************************************91*/
