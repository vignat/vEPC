...
/********************************************************************20**
     ...
     Sid:      leg.x@@/main/lp_crfix_branch/3 - Wed Feb 18 15:11:40 2015
...
typedef struct _egGenCfg
{
  ...
  /* leg_x_001.main_12 : ccpu00139510 Egtpc release 10 upgrade*/
   Bool         prn;       /**< PGW Restart Notification support flag*/
   Bool         mabr;            /**< Modify Access Bearers Request support flag*/
   Bool         ntsr;            /**< Network Triggered Service Restoration support flag */
#ifdef LEGV4
...
typedef struct _egTptSrvCfg
{
   ...
   U16          noOfAssocUSap;
   SpId         uSapIds[EG_MAX_ASSOC_USAP]; /* Associated USAP IDs in case it is a 
                                              single server Per IP(for MultiIP) Configuration */
#endif
...
/********************************************************************30**
         ...
         End of file:     leg.x@@/main/lp_crfix_branch/3 - Wed Feb 18 15:11:40 2015
...
/main/13     ---      leg_x_001.main_12   rss      1. Egtpc Release 10 upgrade
*********************************************************************91*/
