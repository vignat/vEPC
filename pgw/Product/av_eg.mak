...
#
#       Sid:      av_eg.mak@@/main/1 - Tue Aug 17 18:54:38 2010
#
#       Prg:    kc
#
#********************************************************************21*/
...
HIOPTS=-DHI $(HITLCFLG) $(LHILCFLG) $(HIREL15FLG) $(HIFASTFINDFLG) \
       $(HIDBGFLG) -DHI_CMPTBL_FLAG -DHI_MULTI_THREADED -UDHI
...
# GTP layer options
EGOPTS = -DEG -DEGTP_C -DEGTP_U -DEG_REL_930 -DEG_PHASE2 \
         -DDEBUGP \
         -UEG_GROUPED_CHK \
         -UEG_PRNT_DATA \
         -U_EG_PRINT_BUF_ \
         ...
         -DLONG_MSG -USS_MEM_LEAK_STS -DUSE_PURE -DPURE
...
EGLIBOPTS =$(EGOPTS) -DCM_INET2 -DDONT_USE_SYS_LIB -USS_MT_TMR -DEG_PHASE2 $(LEGLCFLG)  -DEU -DLCEGLIHIT -DLCEGUIEGT

# Product options for Acceptance Test Build - DUMMY TUCL ONLY
EGACCOPTS=$(EGOPTS) -DEG_ACC -DxDEBUGP -DEU -DCMXTA_MASTER -DCMXTA_RET_ERR_NONE -DSM $(DHIOPTS) $(EGTLCFLG) $(EGTLWLCFLG) $(LEGLCFLG) -DSS_MULTIPLE_PROCS -DDHI

# Product options for Acceptance Test Build - TUCL + DUMMY-TUCL
EGACCOPTS1=$(EGOPTS) -DEG_ACC -DxDEBUGP -DEU -DCMXTA_MASTER -DCMXTA_RET_ERR_NONE -DSM $(HIOPTS) $(EGTLCFLG) $(EGTLWLCFLG) $(LEGLCFLG) -DSS_MULTIPLE_PROCS -DDHI -DEG_ACC_INT

# Product options for Acceptance Test Build - STUB for EDM Testing
EGACCOPTS2=$(EGOPTS) -DxDEBUGP -UEU -DCMXTA_MASTER -DCMXTA_RET_ERR_NONE  -DSM $(HIOPTS) $(EGTLCFLG) $(EGTLWLCFLG) $(LEGLCFLG)
...
# default portable for Solaris cc environment
ifeq ($(MACHINE), BIT64)
BINLIB="libav_lnx64eg.a"
else
BINLIB="libav_lnx32eg.a"
endif
#BINLIB="libav_sol32eg.a"
#BINLIB="libav_sol32eg.a"
...
CPRDLIBOPTS="$(CLIBOPTS) $(EGLIBOPTS) $(HIOPTS)"
...
#********************************************************************30**
#
#        End of file:     av_eg.mak@@/main/1 - Tue Aug 17 18:54:38 2010
#
#********************************************************************31*/
#
#********************************************************************40**
...
#----------- -------- ---- -----------------------------------------------
#/main/1      ---     vprabhu           1. Updated for initial of PGW 1.1.
#********************************************************************91*/
