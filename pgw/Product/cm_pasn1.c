...
/********************************************************************20**
     ...
     Sid:      cm_pasn1.c@@/main/uchakala_feat_lpdev_sgsn_branch/1 - Fri Jul  4 12:56:36 2014
...
PRIVATE S16 cmPAsnEncTprntCont ARGS((CmPAsnMsgCp *msgCp)); 
...
CONSTANT CMPASNENCFUNC  cmPAsnEncFuncMtx[CM_PASN_MAX_TET] =
{
   ...
   cmPAsnEncTprntCont           /* 40 Transparent container */
};
...
*
*       Desc:  This function encodes Transparent container
*
*       Ret:   ROK 
*
*       Notes: None 
...
#ifdef ANSI
PRIVATE S16 cmPAsnEncTprntCont
(
CmPAsnMsgCp  *msgCp    /* message control pointer */
)
#else
PRIVATE S16 cmPAsnEncTprntCont (msgCp)
CmPAsnMsgCp  *msgCp;   /* message control pointer */
#endif
{
  Bool              fragFlag;     /* Fragmentation Flag */
...
/* cm_pasn1_c_002.main_13 */
  ...
  /*Length will be encoded as part of the encoding of the ClassIE*/
#if 0
  /* Encode extension bit and length, if need be */
  if( (ret = cmPAsnEncStrLen(msgCp, (length), min,max, 
                      &fragFlag, CM_PASN_OCTSTR_TYPE) )!= ROK)
...
/********************************************************************30**
         ...
         End of file:     cm_pasn1.c@@/main/uchakala_feat_lpdev_sgsn_branch/1 - Fri Jul  4 12:56:36 2014
