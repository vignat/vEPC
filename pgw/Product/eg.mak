...
#
#       Sid:      eg.mak@@/main/6 - Fri Feb  4 18:37:14 2011
#
#       Prg:    kc
#
#********************************************************************21*/
...
# HI files directory
HI_DIR=/u/prd/rls/1000158/2.1/00/crnt/
...
PY_LIB_DIR=/usr/ccpu/python/linux/32bit/python-2.4.4/lib
...
# new acceptance test include path
LIB_INC_PATH="-I$(CM_DIR) -I$(SS_DIR) -I$(OS_DIR) -I$(EG_DIR) -I$(HI_DIR) -I$(PY_LIB_DIR)"
...
EGPTOPTS=$(EGOPTS) -DCM_INET2 -DDONT_USE_SYS_LIB

EGLIBOPTS =$(EGOPTS) -DCM_INET2 -DDONT_USE_SYS_LIB

# Product options for Acceptance Test Build - DUMMY TUCL ONLY
EGACCOPTS=$(EGOPTS) -DEG_ACC -DDEBUGP -DEU -DCMXTA_MASTER -DCMXTA_RET_ERR_NONE -DSM $(DHIOPTS) $(EGTLCFLG) $(EGTLWLCFLG) $(LEGLCFLG) -DSS_MULTIPLE_PROCS -DDHI -DEU $(HIOPTS)

# Product options for Acceptance Test Build - TUCL + DUMMY-TUCL
EGACCOPTS1=$(EGOPTS) -DEG_ACC -DDEBUGP -DEU -DCMXTA_MASTER -DCMXTA_RET_ERR_NONE -DSM $(HIOPTS) $(EGTLCFLG) $(EGTLWLCFLG) $(LEGLCFLG) -DSS_MULTIPLE_PROCS -DDHI -DEG_ACC_INT

# Product options for Acceptance Test Build - STUB for EDM Testing
EGACCOPTS2=$(EGOPTS) -DDEBUGP -UEU -DCMXTA_MASTER -DCMXTA_RET_ERR_NONE  -DSM $(HIOPTS) $(EGTLCFLG) $(EGTLWLCFLG) $(LEGLCFLG)

# Product options for SLAVE Compilation.
EGACCOPTS3=$(EGOPTS) -DDEBUGP -UEU  -DxSM $(DHIOPTS) $(EGTLCFLG) $(EGTLWLCFLG) $(LEGLCFLG)
...
GENACCOSOPTS=-DSS -DCMFILE_REORG_1 -DCMFILE_REORG_2 -USS_SINGLE_THREADED -DSS_TICKS_SEC=SS_1MS  -DSS_DRVR_SUPPORT -DSM -DSS_MULTIPLE_PROCS -DxIPV6_SUPPORTED -DxUSE_PURE -DxSS_MT_TMR
...
# testing
LNXOSOPTS=-DSS_LINUX -DEGACC_PRETTY_PRINT -D_GNU_SOURCE $(MTOSOPTS)
...
LNXENV="-DSUNOS -DSS_LINUX -DANSI -DxUSE_PURE -D_GNU_SOURCE "
...
LNXLIBS="-lm -ldl -lutil /usr/ccpu/python/linux/32bit/python-2.4.4/lib/python2.4/config/libpython2.4.a"
LNXLIBS4="-lm -ldl -lutil /usr/ccpu/python/linux/32bit/python-2.4.4/lib/python2.4/config/libpython2.4.a"
LNXLINT="lint"
LNXLIBLD="ld"
LNXLNTOPTS="-c -F -p -v"
...
#
# For ANSI Compilation
PURENV="-DSUNOS -DSS_LINUX -DANSI -DPURE -DUSE_PURE -D_GNU_SOURCE"
...
PURCC="purify -cache-dir=\tmp -windows=yes gcc -m32"
PURLD="purify -cache-dir=\tmp -windows=yes gcc -m32"
...
PURCOVCC="purecov -cache-dir=\tmp -windows=yes gcc -m32"
PURCOVLD="purecov -cache-dir=\tmp -windows=yes gcc -m32"
...
LEG_INC=$(CM_DIR)/leg.h $(CM_DIR)/leg.x

# TUCL Layer Management - LHI includes
LHI_INC=$(CM_DIR)/lhi.h $(CM_DIR)/lhi.x
...
CM_INC= $(CM_DIR)/cm_err.h   $(CM_DIR)/cm_lib.x   \
	...
	$(OS_DIR)/cm_mem.h   $(OS_DIR)/cm_mem.x
...
EGSM_SRCS = $(EGSM_DIR)/smegbdy1.c \
	    ...
	    $(EGSM_DIR)/smeg_smutl.c \
	    $(EGSM_DIR)/smeg_snutl.c \
	    $(EGSM_DIR)/smeg_s2a_s2butl.c \
	    $(EGSM_DIR)/smegptmi.c

# Product stack manager objects-----------------------------------------
EGSM_OBJS = $(SY_DIR)/smegbdy1.$(OBJ) \
	    $(SY_DIR)/smegexms.$(OBJ) \
	    $(SY_DIR)/smegptmi.$(OBJ) \
	    ...
	    $(SY_DIR)/smeg_smutl.$(OBJ) \
	    $(SY_DIR)/smeg_s2a_s2butl.$(OBJ) \
	    $(SY_DIR)/smeg_snutl.$(OBJ)
...
$(SY_DIR)/hi_bdy1.$(OBJ): $(HI_DIR)/hi_bdy1.c $(SYS_INC) $(CM_INC) $(EGALL_INC)
	$(CC) -c $(CPRDOPTS) $(HI_DIR)/hi_bdy1.c -o $(SY_DIR)/hi_bdy1.$(OBJ)

$(SY_DIR)/hi_bdy2.$(OBJ): $(HI_DIR)/hi_bdy2.c $(SYS_INC) $(CM_INC) $(EGALL_INC)
	$(CC) -c $(CPRDOPTS) $(HI_DIR)/hi_bdy2.c -o $(SY_DIR)/hi_bdy2.$(OBJ)

$(SY_DIR)/hi_bdy3.$(OBJ): $(HI_DIR)/hi_bdy3.c $(SYS_INC) $(CM_INC) $(EGALL_INC)
	$(CC) -c $(CPRDOPTS) $(HI_DIR)/hi_bdy3.c -o $(SY_DIR)/hi_bdy3.$(OBJ)

$(SY_DIR)/hi_ex_ms.$(OBJ): $(HI_DIR)/hi_ex_ms.c $(SYS_INC) $(CM_INC) $(EGALL_INC)
	$(CC) -c $(CPRDOPTS) $(HI_DIR)/hi_ex_ms.c -o $(SY_DIR)/hi_ex_ms.$(OBJ)

$(SY_DIR)/hi_ptui.$(OBJ): $(HI_DIR)/hi_ptui.c $(SYS_INC) $(CM_INC) $(EGALL_INC)
	$(CC) -c $(CPRDOPTS) $(HI_DIR)/hi_ptui.c -o $(SY_DIR)/hi_ptui.$(OBJ)

$(SY_DIR)/hi_ptmi.$(OBJ): $(HI_DIR)/hi_ptmi.c $(SYS_INC) $(CM_INC) $(EGALL_INC)
	$(CC) -c $(CPRDOPTS) $(HI_DIR)/hi_ptmi.c -o $(SY_DIR)/hi_ptmi.$(OBJ)

$(SY_DIR)/hi_id.$(OBJ): $(HI_DIR)/hi_id.c $(SYS_INC) $(CM_INC) $(EGALL_INC)
	$(CC) -c $(CPRDOPTS) $(HI_DIR)/hi_id.c -o $(SY_DIR)/hi_id.$(OBJ)
...
$(SY_DIR)/leg.$(OBJ): $(CM_DIR)/leg.c $(SYS_INC) $(EGT_INC)
	$(CC) -c $(CPRDOPTS) $(CM_DIR)/leg.c -o $(SY_DIR)/leg.$(OBJ)

$(SY_DIR)/lhi.$(OBJ): $(CM_DIR)/lhi.c $(SYS_INC) $(EGALL_INC)
	$(CC) -c $(CPRDOPTS) $(CM_DIR)/lhi.c -o $(SY_DIR)/lhi.$(OBJ)


# stack manager build-------------------------------------------

$(SY_DIR)/sm_bdy1.$(OBJ): $(SM_DIR)/sm_bdy1.c $(SYS_INC) $(LEG_INC)
	$(CC) -c $(CSMOPTS) $(SM_DIR)/sm_bdy1.c -o $(SY_DIR)/sm_bdy1.$(OBJ)

$(SY_DIR)/sm_ex_ms.$(OBJ): $(SM_DIR)/sm_ex_ms.c $(SYS_INC) $(LEG_INC)
	$(CC) -c $(CSMOPTS) $(SM_DIR)/sm_ex_ms.c -o $(SY_DIR)/sm_ex_ms.$(OBJ)

$(SY_DIR)/eg_dbutl.$(OBJ): $(EGSM_DIR)/eg_dbutl.c $(SYS_INC) $(LEG_INC)
	$(CC) -c $(CPRDOPTS) $(EGSM_DIR)/eg_dbutl.c -o $(SY_DIR)/eg_dbutl.$(OBJ)
...
$(SY_DIR)/smeg_smutl.$(OBJ): $(EGSM_DIR)/smeg_smutl.c $(SYS_INC) $(LEG_INC)
	$(CC) -c $(CPRDOPTS) $(EGSM_DIR)/smeg_smutl.c -o $(SY_DIR)/smeg_smutl.$(OBJ)

$(SY_DIR)/smeg_snutl.$(OBJ): $(EGSM_DIR)/smeg_snutl.c $(SYS_INC) $(LEG_INC)
	$(CC) -c $(CPRDOPTS) $(EGSM_DIR)/smeg_snutl.c -o $(SY_DIR)/smeg_snutl.$(OBJ)


$(SY_DIR)/smeg_s2a_s2butl.$(OBJ): $(EGSM_DIR)/smeg_s2a_s2butl.c $(SYS_INC) $(LEG_INC)
	$(CC) -c $(CPRDOPTS) $(EGSM_DIR)/smeg_s2a_s2butl.c -o $(SY_DIR)/smeg_s2a_s2butl.$(OBJ)

$(SY_DIR)/eg_dbs3.$(OBJ): $(EGSM_DIR)/eg_dbs3.c $(SYS_INC) $(LEG_INC)
	$(CC) -c $(CPRDOPTS) $(EGSM_DIR)/eg_dbs3.c -o $(SY_DIR)/eg_dbs3.$(OBJ)

$(SY_DIR)/eg_dbs4.$(OBJ): $(EGSM_DIR)/eg_dbs4.c $(SYS_INC) $(LEG_INC)
	$(CC) -c $(CPRDOPTS) $(EGSM_DIR)/eg_dbs4.c -o $(SY_DIR)/eg_dbs4.$(OBJ)

$(SY_DIR)/eg_dbs5.$(OBJ): $(EGSM_DIR)/eg_dbs5.c $(SYS_INC) $(LEG_INC)
	$(CC) -c $(CPRDOPTS) $(EGSM_DIR)/eg_dbs5.c -o $(SY_DIR)/eg_dbs5.$(OBJ)

$(SY_DIR)/eg_dbs10.$(OBJ): $(EGSM_DIR)/eg_dbs10.c $(SYS_INC) $(LEG_INC)
	$(CC) -c $(CPRDOPTS) $(EGSM_DIR)/eg_dbs10.c -o $(SY_DIR)/eg_dbs10.$(OBJ)

$(SY_DIR)/eg_dbs11.$(OBJ): $(EGSM_DIR)/eg_dbs11.c $(SYS_INC) $(LEG_INC)
	$(CC) -c $(CPRDOPTS) $(EGSM_DIR)/eg_dbs11.c -o $(SY_DIR)/eg_dbs11.$(OBJ)

$(SY_DIR)/eg_dbs16.$(OBJ): $(EGSM_DIR)/eg_dbs16.c $(SYS_INC) $(LEG_INC)
	$(CC) -c $(CPRDOPTS) $(EGSM_DIR)/eg_dbs16.c -o $(SY_DIR)/eg_dbs16.$(OBJ)

$(SY_DIR)/eg_dbsm.$(OBJ): $(EGSM_DIR)/eg_dbsm.c $(SYS_INC) $(LEG_INC)
	$(CC) -c $(CPRDOPTS) $(EGSM_DIR)/eg_dbsm.c -o $(SY_DIR)/eg_dbsm.$(OBJ)

$(SY_DIR)/eg_dbsn.$(OBJ): $(EGSM_DIR)/eg_dbsn.c $(SYS_INC) $(LEG_INC)
	$(CC) -c $(CPRDOPTS) $(EGSM_DIR)/eg_dbsn.c -o $(SY_DIR)/eg_dbsn.$(OBJ)

$(SY_DIR)/eg_dbsi.$(OBJ): $(EGSM_DIR)/eg_dbsi.c $(SYS_INC) $(LEG_INC)
	$(CC) -c $(CPRDOPTS) $(EGSM_DIR)/eg_dbsi.c -o $(SY_DIR)/eg_dbsi.$(OBJ)

$(SY_DIR)/eg_dbs2b.$(OBJ): $(EGSM_DIR)/eg_dbs2b.c $(SYS_INC) $(LEG_INC)
	$(CC) -c $(CPRDOPTS) $(EGSM_DIR)/eg_dbs2b.c -o $(SY_DIR)/eg_dbs2b.$(OBJ)

$(SY_DIR)/eg_dbs2a.$(OBJ): $(EGSM_DIR)/eg_dbs2a.c $(SYS_INC) $(LEG_INC)
	$(CC) -c $(CPRDOPTS) $(EGSM_DIR)/eg_dbs2a.c -o $(SY_DIR)/eg_dbs2a.$(OBJ)
...
$(SY_DIR)/cm_mem.$(OBJ): $(OS_DIR)/cm_mem.c $(SYS_INC) $(SS_INC) $(OS_INC)
	$(CC) -c $(COSOPTS) $(OS_DIR)/cm_mem.c -o $(SY_DIR)/cm_mem.$(OBJ)
...
#********************************************************************30**
#
#        End of file:     eg.mak@@/main/6 - Fri Feb  4 18:37:14 2011
#
#********************************************************************31*/
#
#********************************************************************40**
...
#/main/5      ---      rss					  1. Changed the fo call back function
#                                           changes release
#/main/5      ---      pmacharla         Initial for eGTP release 2.1
#/main/5    eg009.201  asaurabh          1. S2A and S2B interface support
#													     to eGTP
#/main/5    eg012.201  shpandey          1. Added Compile time option for linux environment
#********************************************************************91*/
