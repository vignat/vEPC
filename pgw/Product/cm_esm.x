...
/**********************************************************************
     ...
     Sid:      cm_esm.x@@/main/nodal_main/1 - Thu Nov 21 09:40:07 2013
...
typedef struct  cmEsmdBearResModRej
{
   CmEsmCause        cause;
   CmEsmProtCfgOpt   protCfgOpt;
} CmEsmdBearResModRej;
...
typedef struct cmEsmDeActDedBearCtxtReq
{
 /*  CmEsmBearerId     bearerId;*/
   CmEsmCause        cause;
   CmEsmProtCfgOpt   protCfgOpt;
}CmEsmDeActDedBearCtxtReq;
...
/* Modify dedicated EPS bearer context request */
...
/* PDN disconnectivity reject */
typedef struct cmEsmPdnDisconnRej
{
   CmEsmCause        cause;
   CmEsmProtCfgOpt   protCfgOpt;
}CmEsmPdnDisconnRej;
...
typedef struct cmEsmModBearCtxtReq
{
   CmEsmEpsQos       epsQos;
   CmEsmTft          tft;
   CmEsmQoS          qos;
...
typedef struct cmEsmModBearCtxtAcc
{
   CmEsmProtCfgOpt   protCfgOpt;
}CmEsmModBearCtxtAcc;
/*  Modify EPS bearer context reject */
typedef struct cmEsmModBearCtxtRej
{
   CmEsmCause         cause;
   CmEsmProtCfgOpt   protCfgOpt;
}CmEsmModBearCtxtRej;
...
/*  cm_esm_x_001.main_3 : Added security feature enhancement */
#ifdef CM_NAS_SEC
/* Esm information response */
typedef struct cmEsmInfoRsp
{
   CmEsmAccessPtName apn;
   CmEsmProtCfgOpt   protCfgOpt;
} CmEsmInfoRsp;
...
typedef struct cmEsmMsg
{
   ...
   union
   {
      ...
      CmEsmdBearResModRej     bearModRej;
      CmEsmPdnConnReq         conReq;
      CmEsmPdnConnRej         conRej;
      CmEsmStatus             esmSts;
      CmEsmDeActBearCtxtReq   deactBearReq;
      CmEsmDeActBearCtxtAcc   deactBearAcc;
      CmEsmModBearCtxtReq     modBearCtxtReq;
      CmEsmModBearCtxtAcc     modBearCtxtAcc;
      CmEsmModBearCtxtRej     modBearCtxtRej;
      CmEsmPdnDisconnReq      disConReq;
      CmEsmPdnDisconnRej      disConRej;
#ifdef CM_NAS_SEC
      CmEsmInfoRsp            infoRsp;
#endif /* CM_NAS_SEC */
   }u;
}CmEsmMsg;
...
/**********************************************************************
         ...
         End of file:     cm_esm.x@@/main/nodal_main/1 - Thu Nov 21 09:40:07 2013
