...
/********************************************************************20**
     ...
     Sid:      envdep.h@@/main/nodal_main/1 - Thu Nov 21 09:40:21 2013
...
/* envdep_h_001.main_79 Change typedef void to #define void*/
/* typedef void Void; */
#define Void void               
...
typedef char            S8;       /* signed - 8 bits */
#else
/* removed singed to supress sprintf' differ in signedness warnings */
typedef char     S8;       /* signed - 8 bits*/
#endif
typedef unsigned char   U8;       /* unsigned - 8 bits */
...
/********************************************************************30**
         ...
         End of file:     envdep.h@@/main/nodal_main/1 - Thu Nov 21 09:40:21 2013
...
/main/79     ---      envdep_h_001.main_79 rtarimal   1. RVDT compiler warning fixes
*********************************************************************91*/
