...
/********************************************************************20**
        ...
        Sid:      cm_inet.c@@/main/nodal_main/1 - Thu Nov 21 09:40:09 2013
...
#endif
{
   ...
   *numRdyFds = 0;
   ...
   {
#ifdef CMINETDBG
      sprintf(prntBuf, "cmInetPoll() : number of file descriptor (%d) invalid \n",numFds);
      ...
      {
#ifdef CMINETDBG
      sprintf(prntBuf, "cmInetPoll() : Invalid Parameter (pollFdArr is NULL)");
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINETXXX, 0, prntBuf);
#endif /* CMINETDBG */      
         RETVALUE(RFAILED);
      }
   ...
   if (ret == INET_ERR)
   {
      switch(INET_ERR_CODE)
      {
         ...
         default:
#ifdef CMINETDBG
            sprintf(prntBuf, "File: %s, cmInetPoll() failed on line: %d \n\
...
#endif
{
   ...
   {
#ifdef CMINETDBG
      sprintf(prntBuf, "cmInetPollSetFd() : Invalid idx(%d) \n",idx);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINETXXX, 0, prntBuf);
#endif /* CMINETDBG */
      ...
      {
#ifdef CMINETDBG
      sprintf(prntBuf, "cmInetPollSetFd() : Invalid Parameter (pollFdArr is NULL)");
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINETXXX, 0, prntBuf);
#endif /* CMINETDBG */      
         RETVALUE(RFAILED);
      }
...
#ifdef CMINETDBG
#ifndef ALIGN_64BIT
      sprintf(prntBuf, "cmInetPollSetFd() Before Setting fd: sockFd->fd(%ld) Index(%d) Event(%d) \n Fd and event to be set   fd(%ld) event(%d) \n",
            pollFdArr[idx].fd,idx, pollFdArr[idx].events,sockFd->fd,eventMask);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINETXXX, 0, prntBuf);
#else
      sprintf(prntBuf, "cmInetPollSetFd() Before Setting fd: sockFd->fd(%d) Index(%d) Event(%d) \n Fd and event to be set   fd(%d) event(%d) \n",
            pollFdArr[idx].fd,idx, pollFdArr[idx].events,sockFd->fd,eventMask);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINETXXX, 0, prntBuf);
#endif /*ALIGN_64BIT */
#endif /* CMINETDBG */
...
#ifdef CMINETDBG
#ifndef ALIGN_64BIT
      sprintf(prntBuf, "cmInetPollSetFd() After Setting fd: sockFd->fd(%ld) Index(%d) Event(%d) \n",
            pollFdArr[idx].fd,idx, pollFdArr[idx].events);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINETXXX, 0, prntBuf);
#else
      sprintf(prntBuf, "cmInetPollSetFd() After Setting fd: sockFd->fd(%d) Index(%d) Event(%d) \n",
            pollFdArr[idx].fd,idx, pollFdArr[idx].events);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINETXXX, 0, prntBuf);
#endif /*ALIGN_64BIT */
#endif /* CMINETDBG */
...
#endif
{
   ...
   {
#ifdef CMINETDBG
      sprintf(prntBuf, "cmInetPollFdIsSet() : Invalid Index (%d) \n",idx);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINETXXX, 0, prntBuf);
#endif /* CMINETDBG */
      RETVALUE(RFAILED);
   }
      ...
      {
#ifdef CMINETDBG
      sprintf(prntBuf, "cmInetPollFdIsSet() : Invalid Parameter (pollFdArr is NULL)");
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINETXXX, 0, prntBuf);
#endif /* CMINETDBG */      
         RETVALUE(RFAILED);
      }
...
#endif
{
   ...
   {
#ifdef CMINETDBG
      sprintf(prntBuf, "cmInetPollClearFdREvent() : Invalid Index (%d) \n",idx);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINETXXX, 0, prntBuf);
#endif /* CMINETDBG */
      RETVALUE(RFAILED);
   }
      ...
      {
#ifdef CMINETDBG
      sprintf(prntBuf, "cmInetPollClearFdREvent() : Invalid Parameter (pollFdArr is NULL)");
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINETXXX, 0, prntBuf);
#endif /* CMINETDBG */      
         RETVALUE(RFAILED);
      }
...
#ifdef CMINETDBG
#ifndef ALIGN_64BIT
      sprintf(prntBuf, "cmInetPollClearFdREvent() Before clearing fd revents with eventMask: \n sockFd->fd(%ld) Index(%d) REvent(%d) EventMask(%d) \n",
...
#ifdef CMINETDBG
#ifndef ALIGN_64BIT
      sprintf(prntBuf, "cmInetPollClearFdREvent() After clearing fd revents with eventMask: \n sockFd->fd(%ld) Index(%d) REvent(%d) EventMask(%d) \n",
            pollFdArr[idx].fd,idx, pollFdArr[idx].revents,eventMask);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINETXXX, 0, prntBuf);
#else
      sprintf(prntBuf, "cmInetPollClearFdREvent() After clearing fd revents with eventMask: \n sockFd->fd(%d) Index(%d) REvent(%d) EventMask(%d) \n",
...
#endif
{
   ...
   {
#ifdef CMINETDBG
      sprintf(prntBuf, "cmInetPollClearFdEvent() : Invalid Index (%d) \n",idx);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINETXXX, 0, prntBuf);
#endif /* CMINETDBG */
      RETVALUE(RFAILED);
   }
      ...
      {
#ifdef CMINETDBG
      sprintf(prntBuf, "cmInetPollClearFdEvent() : Invalid Parameter (pollFdArr is NULL)");
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINETXXX, 0, prntBuf);
#endif /* CMINETDBG */      
         RETVALUE(RFAILED);
      }
...
#ifdef CMINETDBG
#ifndef ALIGN_64BIT
      sprintf(prntBuf, "cmInetPollClearFdEvent() Before clearing fd events with eventMask: \n sockFd->fd(%ld) Index(%d) Event(%d) EventMask(%d) \n",
...
#ifdef CMINETDBG
#ifndef ALIGN_64BIT
      sprintf(prntBuf, "cmInetPollClearFdEvent() After clearing fd events with eventMask: sockFd->fd(%ld) Index(%d) Event(%d) EventMask(%d) \n",
            pollFdArr[idx].fd,idx, pollFdArr[idx].events,eventMask);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINETXXX, 0, prntBuf);
#else
      sprintf(prntBuf, "cmInetPollClearFdEvent() After clearing fd events with eventMask: sockFd->fd(%d) Index(%d) Event(%d) EventMask(%d) \n",
            pollFdArr[idx].fd,idx, pollFdArr[idx].events,eventMask);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINETXXX, 0, prntBuf);
#endif /*ALIGN_64BIT */
#endif /* CMINETDBG */
...
#endif
{
   ...
   {
#ifdef CMINETDBG
      sprintf(prntBuf, "cmInetPollDelFd() : Invalid Index \n Current Index (%d) Delete Index (%d) \n",lastIdx,delIdx);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINETXXX, 0, prntBuf);
#endif /* CMINETDBG */
      RETVALUE(RFAILED);
   }
      ...
      {
#ifdef CMINETDBG
      sprintf(prntBuf, "cmInetPollDelFd() : Invalid Parameter (pollFdArr is NULL)");
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINETXXX, 0, prntBuf);
#endif /* CMINETDBG */      
         RETVALUE(RFAILED);
      }
...
#ifdef CMINETDBG
#ifndef ALIGN_64BIT
      sprintf(prntBuf, "cmInetPollDelFd() Deleting the sockFd->fd(%ld) Index(%d) Event(%d) revent(%d) \n",
            pollFdArr[delIdx].fd,delIdx, pollFdArr[delIdx].events,pollFdArr[delIdx].revents);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINETXXX, 0, prntBuf);
#else
      sprintf(prntBuf, "cmInetPollDelFd() After clearing fd events with eventMask: sockFd->fd(%d) Index(%d) Event(%d) EventMask(%d) \n",
            pollFdArr[delIdx].fd,delIdx, pollFdArr[delIdx].events,pollFdArr[delIdx].revents);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINETXXX, 0, prntBuf);
#endif /*ALIGN_64BIT */
#endif /* CMINETDBG */
...
*/
      ...
      {
#ifdef CMINETDBG
      sprintf(prntBuf, "cmInetPollInitFdArr() : Invalid Parameter (pollFdArr is NULL)");
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINETXXX, 0, prntBuf);
#endif /* CMINETDBG */      
         RETVALUE(RFAILED);
      }
...
#endif /* ANSI */
{
   ...
   {   
      ...
      sprintf(prntBuf, "cmInetSocket() Failed : errno(%d), sockFd->fd(%ld)\n", 
            INET_ERR_CODE, sockFd->fd);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINET001, 0, prntBuf);
#else
      sprintf(prntBuf, "cmInetSocket() Failed : errno(%d), sockFd->fd(%d)\n", 
            INET_ERR_CODE, sockFd->fd);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINET001, 0, prntBuf);
#endif /*ALIGN_64BIT */
#endif /* CMINETDBG */
...
#ifndef ALIGN_64BIT
            /* cm_inet_c_001.main_54: CMINETLOGERROR added insted of SDisp */
            sprintf(prntBuf, "WSAIoctl() Failed : error(%d), sockFd->fd(%ld)\n", 
                  INET_ERR_CODE, sockFd->fd);
            CMINETLOGERROR(ERRCLS_DEBUG, ECMINET002, 0, prntBuf);
#else
            sprintf(prntBuf, "WSAIoctl() Failed : error(%d), sockFd->fd(%d)\n", 
                  INET_ERR_CODE, sockFd->fd);
            CMINETLOGERROR(ERRCLS_DEBUG, ECMINET002, 0, prntBuf);
#endif /*ALIGN_64BIT*/
#endif /* CMINETDBG */      
...
#ifndef ALIGN_64BIT
      /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
      sprintf(prntBuf, "cmInetBind() Failed : error(%d), addrType(%d)," 
            " port(%d), sockFd->fd(%ld)\n", 
...
#else
#ifndef ALIGN_64BIT
      sprintf(prntBuf, "cmInetBind() Failed : error(%d), addr(0x%lx), port(%d),"
            "sockFd->fd(%ld)\n",
            INET_ERR_CODE , myAddr->address, myAddr->port, sockFd->fd);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINET004, 0, prntBuf);
#else
      sprintf(prntBuf, "cmInetBind() Failed : error(%d), addr(0x%x), port(%d),"
            " sockFd->fd(%d)\n",
            INET_ERR_CODE , myAddr->address, myAddr->port, sockFd->fd);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINET004, 0, prntBuf);
#endif /*ALIGN_64BIT*/
...
#ifndef ALIGN_64BIT
      /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
      sprintf(prntBuf, "No of address(%d) is greater than Max(%d),"
            " sockFd->fd(%ld)\n",
...
#ifndef ALIGN_64BIT
            /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
            sprintf(prntBuf, "can't bind IPV6 address on IPV4 socket,"
                  " sockFd->fd(%ld)\n", sockFd->fd);
...
#ifndef ALIGN_64BIT
      /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
      sprintf(prntBuf, "cmInetSctpBindx() Failed : error(%d), port(%d),"
...
#ifndef ALIGN_64BIT
         /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
         sprintf(prntBuf, "cmInetSctpBindx(Invalid address Type) failed:"
...
#ifndef ALIGN_64BIT
         /* cm_inet_c_001.main_54: CMINETLOGERROR added insted of SDisp */
         sprintf(prntBuf, "Can't connect to IPV6 address through IPV4 socket,"
               " sockFd->fd(%ld)\n", sockFd->fd);
...
#ifndef ALIGN_64BIT
      /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
      sprintf(prntBuf, "cmInetSctpConnectx() failed:error(%d), port(0x%1x),"
            " sockFd->fd(%ld)\n", INET_ERR_CODE, port, sockFd->fd);
...
#endif
{
   ...
   if (ret == INET_ERR)
   {
...
#ifndef ALIGN_64BIT
      /* cm_inet_c_001.main_54: CMINETLOGERROR added insted of SDisp */
      sprintf(prntBuf, "cmInetSctpPeelOff() Failed : error(%d) assocId(%ld),"
      ...
      sprintf(prntBuf, "cmInetSctpPeelOff() Failed : error(%d) assocId(%d),"
            " sockFd->fd(%d)\n", INET_ERR_CODE, assocId, sockFd->fd);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINET011, 0, prntBuf);
#endif /*ALIGN_64BIT*/
#endif /* CMINETDBG */
...
#ifndef ALIGN_64BIT
            /* cm_inet_c_001.main_54: CMINETLOGERROR added insted of SDisp */
            sprintf(prntBuf, "Can't send message to IPV6 address through"
...
#ifndef ALIGN_64BIT
            /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
            sprintf(prntBuf, "can't connect to IPV6 address through IPV4"
                  " socket, sockFd->fd(%ld)\n", sockFd->fd);
...
#ifndef ALIGN_64BIT
      /* cm_inet_c_001.main_54: CMINETLOGERROR added insted of SDisp */
      sprintf(prntBuf, "cmInetSctpSendMsg() Failed : error(%d) ppId(%ld),"
            " strmId(%u),sockFd->fd(%ld)\n",
            INET_ERR_CODE, ppId, strmId, sockFd->fd);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINET013, 0, prntBuf);
#else
      /* cm_inet_c_001.main_55: Fix for compilation warning */
      sprintf(prntBuf, "cmInetSctpSendMsg() Failed : error(%d) ppId(%d),"
...
#ifdef CMINETDBG
      /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
      sprintf(prntBuf, "SGetSBuf failed to allocate memory\n");
...
#ifndef ALIGN_64BIT
      /* cm_inet_c_001.main_54: CMINETLOGERROR added insted of SDisp */
      sprintf(prntBuf, "cmInetSctpRecvMsg() Failed : error(%d),"
            " sockFd->fd(%ld)\n", INET_ERR_CODE, sockFd->fd);
...
#ifndef ALIGN_64BIT
         /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
         sprintf(prntBuf, "cmInetSctpGetPAddrs() Failed : error(%d),"
...
#ifndef ALIGN_64BIT
               /* cm_inet_c_001.main_54: CMINETLOGERROR added insted of SDisp */
               sprintf(prntBuf, "cmInetGetOpt() Failed : Invalid address,"
                     " sockFd->fd(%ld)\n", sockFd->fd);
...
#ifndef ALIGN_64BIT
                  /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
                  sprintf(prntBuf, "invalid address line:sockFd->fd(%ld)\n",
                        sockFd->fd);
                  CMINETLOGERROR(ERRCLS_INT_PAR, ECMINET066, 0, prntBuf);
#else
                  sprintf(prntBuf, "invalid address line:sockFd->fd(%d)\n",
                        sockFd->fd);
                  CMINETLOGERROR(ERRCLS_INT_PAR, ECMINET066, 0, prntBuf);
#endif /*ALIGN_64BIT*/
#endif /* CMINETDBG */
...
#ifndef ALIGN_64BIT
      /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
      sprintf(prntBuf, "cmInetGetOpt() failed on line:"
...
#ifdef CMINETDBG
#ifndef ALIGN_64BIT
      sprintf(prntBuf, "cmInetShutDownSctp() Failed : error(%d), sockFd->fd(%ld)\n",
            INET_ERR_CODE, sockFd->fd);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINET018, 0, prntBuf);
#else
      sprintf(prntBuf, "cmInetShutDownSctp() Failed : error(%d), sockFd->fd(%d)\n",
            INET_ERR_CODE, sockFd->fd);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINET018, 0, prntBuf);
#endif /*ALIGN_64BIT*/
#endif /* CMINETDBG */
...
#ifdef CMINETDBG
#ifndef ALIGN_64BIT
      sprintf(prntBuf, "cmInetAbortSctpAssoc() Failed : error(%d), sockFd->fd(%ld)\n",
            INET_ERR_CODE, sockFd->fd);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINET018, 0, prntBuf);
#else
      sprintf(prntBuf, "cmInetAbortSctpAssoc() Failed : error(%d), sockFd->fd(%d)\n",
            INET_ERR_CODE, sockFd->fd);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINET018, 0, prntBuf);
#endif /*ALIGN_64BIT*/
#endif /* CMINETDBG */
   ...
   if (ret == INET_ERR)
   {
      switch (INET_ERR_CODE)
      {
         ...
         default:
            ...
            /* cm_inet_c_001.main_54: CMINETLOGERROR added insted of SDisp */
#ifndef ALIGN_64BIT
            sprintf(prntBuf, "cmInetConnect() Failed : error(%d),"
...
#ifndef ALIGN_64BIT
      /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
      sprintf(prntBuf, "cmInetListen() Failed : error(%d), backLog(%d),"
...
#ifndef ALIGN_64BIT
         /* cm_inet_c_001.main_54: CMINETLOGERROR added insted of SDisp */
         sprintf(prntBuf, "cmInetAccept() Failed : error(%d),"
              " sockFd->fd(%ld)\n", INET_ERR_CODE, sockFd->fd);
...
#ifdef CMINETDBG
#ifndef ALIGN_64BIT
      sprintf(prntBuf, "cmInetAccept() Failed : sockFd->fd(%ld)\n", sockFd->fd);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINET071, 0, prntBuf);
#else
      sprintf(prntBuf, "cmInetAccept() Failed : sockFd->fd(%d)\n", sockFd->fd);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINET071, 0, prntBuf);
#endif /*ALIGN_64BIT*/
#endif /* CMINETDBG */
         RETVALUE(RFAILED);
...
#ifndef ALIGN_64BIT
      /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
      sprintf(prntBuf, "cmInetSendMsg() Failed : error(%d), msgLen(%d),"
...
#ifndef ALIGN_64BIT
         /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
         sprintf(prntBuf, "cmInetSendMsg() Failed : error(%d),"
               " sockFd->fd(%ld)\n", INET_ERR_CODE, sockFd->fd);
...
#ifndef ALIGN_64BIT
            /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
            sprintf(prntBuf,"cmInetRecvMsg() Failed : error(%d),"
                  " sockFd->fd(%ld)\n", INET_ERR_CODE, sockFd->fd);
...
#ifndef ALIGN_64BIT
            /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
            sprintf(prntBuf,"cmInetRecvMsg(),recevied a message"
...
#ifndef ALIGN_64BIT
            /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
            sprintf(prntBuf,"cmInetRecvMsg() recevied a message > than"
...
#ifndef ALIGN_64BIT
      /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
      sprintf(prntBuf,"cmInetPeekNew() Failed : error(%d), sockFd->fd(%ld)\n", 
            INET_ERR_CODE, sockFd->fd);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINET070, 0, prntBuf);
#else
      sprintf(prntBuf,"cmInetPeekNew() Failed : error(%d), sockFd->fd(%d)\n", 
            INET_ERR_CODE, sockFd->fd);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINET070, 0, prntBuf);
#endif
#endif /* CMINETDBG */
...
#ifndef ALIGN_64BIT
            /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
            sprintf(prntBuf,"cmInetPeek() Failed : error(%d), sockFd->fd(%ld)\n", 
                  INET_ERR_CODE, sockFd->fd);
            CMINETLOGERROR(ERRCLS_DEBUG, ECMINET036, 0, prntBuf);
#else
            sprintf(prntBuf,"cmInetPeek() Failed : error(%d), sockFd->fd(%d)\n", 
                  INET_ERR_CODE, sockFd->fd);
            CMINETLOGERROR(ERRCLS_DEBUG, ECMINET036, 0, prntBuf);
#endif
#endif /* CMINETDBG */
...
#ifndef ALIGN_64BIT
      /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
      sprintf(prntBuf, "cmInetClose() Failed : error(%d), sockFd->fd(%ld)\n",
            INET_ERR_CODE, sockFd->fd);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINET037, 0, prntBuf);
#else
      sprintf(prntBuf, "cmInetClose() Failed : error(%d), sockFd->fd(%d)\n",
            INET_ERR_CODE, sockFd->fd);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINET037, 0, prntBuf);
#endif /*ALIGN_64BIT*/
#endif /* CMINETDBG */
...
#ifndef ALIGN_64BIT
         /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
         sprintf(prntBuf, "cmInetShutdown() Failed : error(%d),"
               " sockFd->fd(%ld)\n", INET_ERR_CODE, sockFd->fd);
...
#ifdef CMINETDBG
            /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
            sprintf(prntBuf, "cmInetSelect() Failed : error(%d)\n",
                  INET_ERR_CODE);
...
#ifndef ALIGN_64BIT
               /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
               sprintf(prntBuf, "Invalid address: sockFd->protType(%d),"
...
#ifndef ALIGN_64BIT
      /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
      sprintf(prntBuf, "cmInetSetOpt() Failed : error(%d), sockFd->fd(%ld)\n",
            INET_ERR_CODE, sockFd->fd);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINET042, 0, prntBuf);
#else
      sprintf(prntBuf, "cmInetSetOpt() Failed : error(%d), sockFd->fd(%d)\n",
            INET_ERR_CODE, sockFd->fd);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINET042, 0, prntBuf);
#endif /*ALIGN_64BIT*/
#endif /* CMINETDBG */
...
#ifndef ALIGN_64BIT
      /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
      sprintf(prntBuf,"cmInetGetNumRead() Failed : error(%d),"
            " sockFd->fd(%ld)\n", INET_ERR_CODE, sockFd->fd);
...
#ifdef CMINETDBG
      /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
      sprintf(prntBuf,"cmInetGetHostByName() Failed : error(%d),"
...
#ifdef CMINETDBG
      /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
      sprintf(prntBuf,"cmInetGetHostByName() Failed : error(%d), hostName(%p),"
            " hostid.h_addrtype(%d)\n",
            INET_ERR_CODE, hostName, hostid.h_addrtype);
...
#ifdef CMINETDBG
      /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
      sprintf(prntBuf,"cmInetGetIpNodeByName() Failed : error(%d),"
...
#ifndef ALIGN_64BIT
      /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
      sprintf(prntBuf, "cmInetGetAddrInfo() Failed : error(%ld), node(%p),"
            " service(%p)\n",  ret, node, service);
      CMINETLOGERROR(ERRCLS_DEBUG, ECMINET052, 0, prntBuf);
#else
      /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
      sprintf(prntBuf, "cmInetGetAddrInfo() Failed : error(%d), node(%p),"
            " service(%p)\n ", ret,  node, service);
...
#ifndef ALIGN_64BIT
            /* cm_inet_c_001.main_54 : CMINETLOGERROR added insted of SDisp */
            sprintf(prntBuf,"cmInetFlushRecvBuf() Failed : error(%d),"
                  " sockFd->fd(%ld)\n", INET_ERR_CODE, sockFd->fd);
...
/********************************************************************30**
         ...
         End of file:     cm_inet.c@@/main/nodal_main/1 - Thu Nov 21 09:40:09 2013
