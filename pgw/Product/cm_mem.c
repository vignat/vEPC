...
/********************************************************************20**
     ...
     Sid:      cm_mem.c@@/main/nodal_main/1 - Thu Nov 21 09:40:14 2013
...
/*cm_mem_c_001.main_23 Fix for specifier mismatch warnings in 64BIT compilation*/          
...
#ifndef MS_MBUF_CORRUPTION /*PST Should not take code Under this flag*/
      *((CmMmEntry **)ptr) =  bkt->next; 
      ...
      {
         Data*  tmp = NULLP;
         MSPD_DBG("Crashing Double Deallocation %d\n", __return_address()-4);
         *tmp = 2;
...
/* cm_mem_c_001.main_12 - addition for block size calculation */
      ...
      if (tmpSize)
#else
         tmpSize = (curHBlk->size - (*size));/* ccpu00125353: warning fix */
         if (tmpSize != 0)
#endif /* SSI_DEBUG_LEVEL1 */
         {
...
/********************************************************************30**
         ...
         End of file:     cm_mem.c@@/main/nodal_main/1 - Thu Nov 21 09:40:14 2013
